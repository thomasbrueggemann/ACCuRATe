...
public class FragmentOsmolar extends Fragment {
   public void onActivityCreated(Bundle var1) {
      ...
      var3.setHint(this.getResources().getText(2131034475).toString());
      var3.setTextColor(17170444);
      var3.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentOsmolar.this.getActivity().findViewById(2131296261)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentOsmolar.this.getActivity().findViewById(2131296261)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var4.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentOsmolar.this.getActivity().findViewById(2131296264)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentOsmolar.this.getActivity().findViewById(2131296264)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var5.setHint(this.getResources().getText(2131034483).toString());
      var5.setTextColor(17170444);
      var5.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentOsmolar.this.getActivity().findViewById(2131296267)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentOsmolar.this.getActivity().findViewById(2131296267)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var8.setOnClickListener(new OnClickListener() {
         public void onClick(View var1) {
            if(!var3.getText().toString().isEmpty() && !var4.getText().toString().isEmpty() && !var5.getText().toString().isEmpty()) {
               ...
               float var3x = Float.parseFloat(var5.getText().toString());
               float var4x = Float.parseFloat(var4.getText().toString());
               var6.setVisibility(0);
               double var5x = (double)(2.0F * var2 + var3x / 18.0F) + (double)var4x / 5.6D;
               var6.setText(Double.toString(var5x) + "mOsm/kg");
            } else {
               Toast.makeText(FragmentOsmolar.this.getActivity(), FragmentOsmolar.this.getResources().getText(2131034150).toString(), 0).show();
            }
         }
      });
      ...
      ((TextView)this.getActivity().findViewById(2131296258)).setText(this.getResources().getText(2131034484).toString());
      ...
      ((LinearLayout)this.getActivity().findViewById(2131296300)).addView(var5);
      ((LinearLayout)this.getActivity().findViewById(2131296302)).addView(var4);
