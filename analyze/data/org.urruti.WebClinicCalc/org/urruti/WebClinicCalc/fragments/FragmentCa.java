...
public class FragmentCa extends Fragment {
   public void onActivityCreated(Bundle var1) {
      ...
      var3.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentCa.this.getActivity().findViewById(2131296261)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentCa.this.getActivity().findViewById(2131296261)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var4.setHint(this.getResources().getText(2131034166).toString());
      var4.setTextColor(17170444);
      var4.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentCa.this.getActivity().findViewById(2131296264)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentCa.this.getActivity().findViewById(2131296264)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var7.setOnClickListener(new OnClickListener() {
         public void onClick(View var1) {
            if(!var3.getText().toString().isEmpty() && !var4.getText().toString().isEmpty()) {
               ...
               float var4x = (float)(0.8D * (double)(4.0F - var3x) + (double)var2);
               var5.setText(Float.toString(var4x));
            } else {
               Toast.makeText(FragmentCa.this.getActivity(), FragmentCa.this.getResources().getText(2131034150).toString(), 0).show();
            }
         }
      });
      ...
      ((TextView)this.getActivity().findViewById(2131296258)).setText(this.getResources().getText(2131034167).toString());
      ...
      ((LinearLayout)this.getActivity().findViewById(2131296400)).addView(var7);
      ((LinearLayout)this.getActivity().findViewById(2131296396)).addView(var3);
      ((LinearLayout)this.getActivity().findViewById(2131296398)).addView(var4);
      ((LinearLayout)this.getActivity().findViewById(2131296402)).addView(var5);
      ((LinearLayout)this.getActivity().findViewById(2131296404)).addView(var6);
   }

   public View onCreateView(LayoutInflater var1, ViewGroup var2, Bundle var3) {
      return var1.inflate(2130903051, var2, false);
   }
