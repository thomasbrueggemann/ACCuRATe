   ...
   public void onActivityCreated(Bundle var1) {
      ...
      var4.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentOne.this.getActivity().findViewById(2131296261)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentOne.this.getActivity().findViewById(2131296261)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var5.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentOne.this.getActivity().findViewById(2131296264)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentOne.this.getActivity().findViewById(2131296264)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      if(var3) {
         ...
         var6.setOnFocusChangeListener(new OnFocusChangeListener() {
            public void onFocusChange(View var1, boolean var2) {
               if(var2) {
                  ((Button)FragmentOne.this.getActivity().findViewById(2131296573)).setBackgroundColor(-16711681);
               } else {
                  ((Button)FragmentOne.this.getActivity().findViewById(2131296573)).setBackgroundColor(-16777216);
               }
            }
         });
      ...
      var9.setOnClickListener(new OnClickListener() {
         public void onClick(View var1) {
            FragmentManager var2 = FragmentOne.this.getFragmentManager();
      ...
      var10.setOnClickListener(new OnClickListener() {
         public void onClick(View var1) {
            if(!var4.getText().toString().isEmpty() && !var5.getText().toString().isEmpty()) {
               ...
               if(var6x < 18.5D) {
                  var8.setText(FragmentOne.this.getResources().getText(2131034151).toString());
                  var8.setTextColor(-256);
               } else if(var6x < 25.0D) {
                  var8.setText(FragmentOne.this.getResources().getText(2131034152).toString());
                  var8.setTextColor(-16711936);
               } else if(var6x < 30.0D) {
                  var8.setText(FragmentOne.this.getResources().getText(2131034153).toString());
                  var8.setTextColor(-256);
               } else if(var6x < 35.0D) {
                  var8.setText(FragmentOne.this.getResources().getText(2131034154).toString());
                  var8.setTextColor(-65536);
               } else if(var6x < 40.0D) {
                  var8.setText(FragmentOne.this.getResources().getText(2131034155).toString());
                  var8.setTextColor(-65536);
               } else {
                  var8.setText(FragmentOne.this.getResources().getText(2131034156).toString());
                  var8.setTextColor(-65536);
               }
            } else {
               Toast.makeText(FragmentOne.this.getActivity(), FragmentOne.this.getResources().getText(2131034150).toString(), 0).show();
            }
         }
      });
