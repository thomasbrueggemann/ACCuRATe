...
public class FragmentExcreNa extends Fragment {
   public void onActivityCreated(Bundle var1) {
      ...
      var3.setHint(this.getResources().getText(2131034219).toString());
      var3.setTextColor(17170444);
      var3.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentExcreNa.this.getActivity().findViewById(2131296261)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentExcreNa.this.getActivity().findViewById(2131296261)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var4.setHint(this.getResources().getText(2131034220).toString());
      var4.setTextColor(17170444);
      var4.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentExcreNa.this.getActivity().findViewById(2131296264)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentExcreNa.this.getActivity().findViewById(2131296264)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var5.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentExcreNa.this.getActivity().findViewById(2131296267)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentExcreNa.this.getActivity().findViewById(2131296267)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var6.setOnFocusChangeListener(new OnFocusChangeListener() {
         public void onFocusChange(View var1, boolean var2) {
            if(var2) {
               ((Button)FragmentExcreNa.this.getActivity().findViewById(2131296472)).setBackgroundColor(-16711681);
            } else {
               ((Button)FragmentExcreNa.this.getActivity().findViewById(2131296472)).setBackgroundColor(-16777216);
            }
         }
      });
      ...
      var8.setOnClickListener(new OnClickListener() {
         public void onClick(View var1) {
            if(!var3.getText().toString().isEmpty() && !var4.getText().toString().isEmpty()) {
               ...
               Toast.makeText(FragmentExcreNa.this.getActivity(), FragmentExcreNa.this.getResources().getText(2131034150).toString(), 0).show();
            }
         }
      });
      ...
      ((TextView)this.getActivity().findViewById(2131296258)).setText(this.getResources().getText(2131034225).toString());
