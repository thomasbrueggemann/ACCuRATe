...
public class ActivityChooserModel extends DataSetObservable {
   ...
   private void executePersistHistoryAsyncTaskSDK11() {
      ActivityChooserModel.PersistHistoryAsyncTask var1 = new ActivityChooserModel.PersistHistoryAsyncTask();
      Executor var2 = AsyncTask.SERIAL_EXECUTOR;
      Object[] var3 = new Object[]{new ArrayList(this.mHistoricalRecords), this.mHistoryFileName};
      var1.executeOnExecutor(var2, var3);
   }
   ...
   private final class DefaultSorter implements ActivityChooserModel.ActivitySorter {
      ...
      public void sort(Intent var1, List<ActivityChooserModel.ActivityResolveInfo> var2, List<ActivityChooserModel.HistoricalRecord> var3) {
         ...
         for(int var6 = 0; var6 < var5; ++var6) {
            ...
            var12.weight = 0.0F;
            var4.put(var12.resolveInfo.activityInfo.packageName, var12);
         }
         ...
         for(int var9 = var7; var9 >= 0; --var9) {
            ...
            ActivityChooserModel.ActivityResolveInfo var11 = (ActivityChooserModel.ActivityResolveInfo)var4.get(var10.activity.getPackageName());
            if(var11 != null) {
