...
class class_448 implements class_65 {
   // $FF: renamed from: a (byte[], boolean) java.lang.String
   public String method_338(byte[] var1, boolean var2) {
      byte var3;
      if(var2) {
         var3 = 11;
      } else {
   ...
   public byte[] method_339(String var1, boolean var2) throws IllegalArgumentException {
      byte var3;
      if(var2) {
         var3 = 11;
      } else {
