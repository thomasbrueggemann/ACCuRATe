...
public final class class_281 {
   // $FF: renamed from: Ht java.util.regex.Pattern
   private static final Pattern field_957 = Pattern.compile("\\\\.");
   // $FF: renamed from: Hu java.util.regex.Pattern
   private static final Pattern field_958 = Pattern.compile("[\\\\\"/\b\f\n\r\t]");

   // $FF: renamed from: aK (java.lang.String) java.lang.String
   public static String method_1867(String var0) {
      if(!TextUtils.isEmpty(var0)) {
         Matcher var1 = field_958.matcher(var0);
   ...
   public static boolean method_1868(Object var0, Object var1) {
      if(var0 instanceof JSONObject && var1 instanceof JSONObject) {
         ...
         if(var7.length() == var8.length()) {
            ...
            while(true) {
               ...
               boolean var12;
               try {
                  var12 = method_1868(var7.get(var10), var8.get(var10));
         ...
         if(var2.length() == var3.length()) {
            for(int var4 = 0; var4 < var2.length(); ++var4) {
               boolean var6;
               try {
                  var6 = method_1868(var2.get(var4), var3.get(var4));
