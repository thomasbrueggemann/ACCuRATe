...
public final class class_635 {
   // $FF: renamed from: a (java.lang.String, java.lang.Object, java.lang.StringBuffer, java.lang.StringBuffer) void
   private static void method_3643(String var0, Object var1, StringBuffer var2, StringBuffer var3) throws IllegalAccessException, InvocationTargetException {
      if(var1 != null) {
         if(!(var1 instanceof class_246)) {
            String var4 = method_3646(var0);
            var3.append(var2).append(var4).append(": ");
            if(var1 instanceof String) {
               String var8 = method_3647((String)var1);
               var3.append("\"").append(var8).append("\"");
            } else if(var1 instanceof byte[]) {
               method_3644((byte[])((byte[])var1), var3);
            } else {
               var3.append(var1);
            }
         ...
         if(var0 != null) {
            var3.append(var2).append(method_3646(var0)).append(" <\n");
            var2.append("  ");
         }
            ...
            if((var26 & 1) == 1 && (var26 & 8) != 8 && !var27.startsWith("_") && !var27.endsWith("_")) {
               ...
               if(var28.isArray()) {
                  if(var28.getComponentType() == Byte.TYPE) {
                     method_3643(var27, var29, var2, var3);
                  } else {
                     int var30;
                     if(var29 == null) {
                        var30 = 0;
                     ...
                     for(int var31 = 0; var31 < var30; ++var31) {
                        method_3643(var27, Array.get(var29, var31), var2, var3);
                     }
                  }
               } else {
                  method_3643(var27, var29, var2, var3);
         ...
         for(int var17 = 0; var17 < var16; ++var17) {
            ...
            if(var19.startsWith("set")) {
               ...
               if(((Boolean)var22.invoke(var1, new Object[0])).booleanValue()) {
                  ...
                  method_3643(var20, var24.invoke(var1, new Object[0]), var2, var3);
               }
            }
         }
   ...
   private static void method_3644(byte[] var0, StringBuffer var1) {
      if(var0 == null) {
         var1.append("\"\"");
      } else {
         var1.append('\"');
   ...
   // $FF: renamed from: aK (java.lang.String) java.lang.String
   private static String method_3645(String var0) {
   ...
   private static String method_3646(String var0) {
   ...
   // $FF: renamed from: cB (java.lang.String) java.lang.String
   private static String method_3647(String var0) {
      if(!var0.startsWith("http") && var0.length() > 200) {
         var0 = var0.substring(0, 200) + "[...]";
      }

      return method_3645(var0);
   }

   // $FF: renamed from: e (com.google.android.gms.internal.mf) java.lang.String
   public static <T extends mf> String method_3648(T var0) {
      if(var0 == null) {
         return "";
      } else {
         StringBuffer var1 = new StringBuffer();
         ...
         try {
            method_3643((String)null, var0, new StringBuffer(), var1);
