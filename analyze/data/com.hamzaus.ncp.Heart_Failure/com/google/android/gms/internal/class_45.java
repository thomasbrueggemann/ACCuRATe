...
public interface class_45 extends IInterface {
   ...
   public abstract static class class_1043 extends Binder implements class_45 {
      public class_1043() {
         this.attachInterface(this, "com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
      }

      // $FF: renamed from: p (android.os.IBinder) com.google.android.gms.internal.dc
      public static class_45 method_2524(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
            return (class_45)(var1 != null && var1 instanceof class_45?(class_45)var1:new class_45.class_1044(var0));
         }
      }
   ...
   private static class class_1044 implements class_45 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_4261;

      class_1044(IBinder var1) {
         this.field_4261 = var1;
      }
      ...
      public String getProductId() throws RemoteException {
         ...
         try {
            ...
            this.field_4261.transact(1, var1, var2, 0);
            var2.readException();
      ...
      public void recordPlayBillingResolution(int var1) throws RemoteException {
         ...
         try {
            ...
            var2.writeInt(var1);
            this.field_4261.transact(3, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void recordResolution(int var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchase");
            var2.writeInt(var1);
            this.field_4261.transact(2, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
