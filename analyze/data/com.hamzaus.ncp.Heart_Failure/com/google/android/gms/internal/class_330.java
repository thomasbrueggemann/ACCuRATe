...
public final class class_330 {
   ...
   public static Bitmap method_2109(Bitmap var0) {
      if(var0 == null) {
         return null;
      } else {
   ...
   private static Bitmap method_2110(Drawable var0) {
      if(var0 == null) {
         return null;
   ...
   public static Drawable method_2111(Resources var0, Drawable var1) {
      return new BitmapDrawable(var0, method_2109(method_2110(var1)));
   }
}
