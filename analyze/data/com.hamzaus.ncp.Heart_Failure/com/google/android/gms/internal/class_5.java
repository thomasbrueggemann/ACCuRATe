...
public interface class_5 extends IInterface {
   ...
   public abstract static class class_1137 extends Binder implements class_5 {
      public class_1137() {
         this.attachInterface(this, "com.google.android.gms.ads.internal.client.IAdListener");
      }

      // $FF: renamed from: e (android.os.IBinder) com.google.android.gms.internal.aq
      public static class_5 method_875(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (class_5)(var1 != null && var1 instanceof class_5?(class_5)var1:new class_5.class_1138(var0));
         }
      }
   ...
   private static class class_1138 implements class_5 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_3214;

      class_1138(IBinder var1) {
      ...
      public void onAdClosed() throws RemoteException {
         ...
         try {
            ...
            this.field_3214.transact(1, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onAdFailedToLoad(int var1) throws RemoteException {
         ...
         try {
            ...
            var2.writeInt(var1);
            this.field_3214.transact(2, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void onAdLeftApplication() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
            this.field_3214.transact(3, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onAdLoaded() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
            this.field_3214.transact(4, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onAdOpened() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
            this.field_3214.transact(5, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
