...
public interface class_131 extends IInterface {
   ...
   void method_696(int var1, Bundle var2, int var3, Intent var4) throws RemoteException;

   public abstract static class class_1005 extends Binder implements class_131 {
      public class_1005() {
         this.attachInterface(this, "com.google.android.gms.panorama.internal.IPanoramaCallbacks");
      }

      // $FF: renamed from: bh (android.os.IBinder) com.google.android.gms.internal.ke
      public static class_131 method_2856(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.panorama.internal.IPanoramaCallbacks");
            return (class_131)(var1 != null && var1 instanceof class_131?(class_131)var1:new class_131.class_1006(var0));
         }
      }
   ...
   private static class class_1006 implements class_131 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_2784;

      class_1006(IBinder var1) {
         this.field_2784 = var1;
      }

      // $FF: renamed from: a (int, android.os.Bundle, int, android.content.Intent) void
      public void method_696(int param1, Bundle param2, int param3, Intent param4) throws RemoteException {
