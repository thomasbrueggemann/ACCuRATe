...
public interface class_60 extends IInterface {
   ...
   boolean method_329(class_60 var1) throws RemoteException;
   ...
   public abstract static class class_1327 extends Binder implements class_60 {
      // $FF: renamed from: aY (android.os.IBinder) com.google.android.gms.maps.model.internal.b
      public static class_60 method_4357(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
            return (class_60)(var1 != null && var1 instanceof class_60?(class_60)var1:new class_60.class_1328(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 3:
            ...
            LatLng var19;
            if(var2.readInt() != 0) {
               var19 = LatLng.CREATOR.createFromParcel(var2);
            } else {
               var19 = null;
            }
         ...
         case 17:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
            boolean var6 = this.a(method_4357(var2.readStrongBinder()));
            var3.writeNoException();
            byte var7 = 0;
            if(var6) {
               var7 = 1;
   ...
   private static class class_1328 implements class_60 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_4153;

      class_1328(IBinder var1) {
         this.field_4153 = var1;
      }

      // $FF: renamed from: a (com.google.android.gms.maps.model.internal.b) boolean
      public boolean method_329(class_60 param1) throws RemoteException {
         ...
         label42: {
            ...
            label41: {
               try {
                  ...
                  this.field_4153.transact(4, var1, var2, 0);
                  var2.readException();
                  if(var2.readInt() != 0) {
      ...
      public int getFillColor() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(12, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public String getId() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(2, var1, var2, 0);
            var2.readException();
      ...
      public double getRadius() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(6, var1, var2, 0);
            var2.readException();
      ...
      public int getStrokeColor() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(10, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public float getStrokeWidth() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(8, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public float getZIndex() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(14, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public int hashCodeRemote() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(18, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public boolean isVisible() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(16, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public void remove() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            this.field_4153.transact(1, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void setFillColor(int var1) throws RemoteException {
         ...
         try {
            ...
            var2.writeInt(var1);
            this.field_4153.transact(11, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setRadius(double var1) throws RemoteException {
         ...
         try {
            ...
            this.field_4153.transact(5, var3, var4, 0);
            var4.readException();
         } finally {
            var4.recycle();
            var3.recycle();
      ...
      public void setStrokeColor(int var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            var2.writeInt(var1);
            this.field_4153.transact(9, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setStrokeWidth(float var1) throws RemoteException {
         ...
         try {
            ...
            this.field_4153.transact(7, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setZIndex(float var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
            var2.writeFloat(var1);
            this.field_4153.transact(13, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
