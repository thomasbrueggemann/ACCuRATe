...
public interface class_61 extends IInterface {
   ...
   void method_330(float var1, float var2) throws RemoteException;

   // $FF: renamed from: a (com.google.android.gms.maps.model.internal.c) boolean
   boolean method_331(class_61 var1) throws RemoteException;
   ...
   void method_332(class_157 var1) throws RemoteException;
   ...
   public abstract static class class_1288 extends Binder implements class_61 {
      // $FF: renamed from: aZ (android.os.IBinder) com.google.android.gms.maps.model.internal.c
      public static class_61 method_4161(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            return (class_61)(var1 != null && var1 instanceof class_61?(class_61)var1:new class_61.class_1289(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 3:
            ...
            LatLng var21 = null;
            if(var20 != 0) {
               var21 = LatLng.CREATOR.createFromParcel(var2);
            }
         ...
         case 9:
            ...
            if(var15 != 0) {
               var16 = LatLngBounds.CREATOR.createFromParcel(var2);
            }
         ...
         case 19:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            boolean var6 = this.a(method_4161(var2.readStrongBinder()));
            var3.writeNoException();
            byte var7 = 0;
            if(var6) {
               var7 = 1;
         ...
         case 21:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.l(class_157.class_1317.method_4176(var2.readStrongBinder()));
            var3.writeNoException();
            return true;
         case 1598968902:
   ...
   private static class class_1289 implements class_61 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_3710;

      class_1289(IBinder var1) {
         this.field_3710 = var1;
      }

      // $FF: renamed from: a (float, float) void
      public void method_330(float var1, float var2) throws RemoteException {
         ...
         try {
            ...
            this.field_3710.transact(6, var3, var4, 0);
            var4.readException();
         } finally {
            var4.recycle();
            var3.recycle();
      ...
      // $FF: renamed from: a (com.google.android.gms.maps.model.internal.c) boolean
      public boolean method_331(class_61 param1) throws RemoteException {
      ...
      public float getBearing() throws RemoteException {
         ...
         try {
            ...
            this.field_3710.transact(12, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
         ...
         label42: {
            ...
            label41: {
               try {
                  var8 = true;
                  var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                  this.field_3710.transact(10, var1, var2, 0);
                  var2.readException();
                  if(var2.readInt() != 0) {
                     var6 = LatLngBounds.CREATOR.createFromParcel(var2);
                     var8 = false;
                     break label41;
                  }
      ...
      public float getHeight() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.field_3710.transact(8, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public String getId() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.field_3710.transact(2, var1, var2, 0);
            var2.readException();
         ...
         label42: {
            ...
            label41: {
               try {
                  var8 = true;
                  var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                  this.field_3710.transact(4, var1, var2, 0);
                  var2.readException();
                  if(var2.readInt() != 0) {
      ...
      public float getTransparency() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.field_3710.transact(18, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public float getWidth() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.field_3710.transact(7, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public float getZIndex() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.field_3710.transact(14, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public int hashCodeRemote() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.field_3710.transact(20, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public boolean isVisible() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.field_3710.transact(16, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      // $FF: renamed from: l (com.google.android.gms.dynamic.d) void
      public void method_332(class_157 param1) throws RemoteException {
         // $FF: Couldn't be decompiled
      }
      ...
      public void remove() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            this.field_3710.transact(1, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void setBearing(float var1) throws RemoteException {
         ...
         try {
            ...
            this.field_3710.transact(11, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setDimensions(float var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            var2.writeFloat(var1);
            this.field_3710.transact(5, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setTransparency(float var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            var2.writeFloat(var1);
            this.field_3710.transact(17, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setZIndex(float var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            var2.writeFloat(var1);
            this.field_3710.transact(13, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
