...
public interface class_94 extends IInterface {
   boolean onMyLocationButtonClick() throws RemoteException;

   public abstract static class class_1187 extends Binder implements class_94 {
      public class_1187() {
         this.attachInterface(this, "com.google.android.gms.maps.internal.IOnMyLocationButtonClickListener");
      }

      // $FF: renamed from: aM (android.os.IBinder) com.google.android.gms.maps.internal.n
      public static class_94 method_4061(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IOnMyLocationButtonClickListener");
            return (class_94)(var1 != null && var1 instanceof class_94?(class_94)var1:new class_94.class_1188(var0));
         }
      }
   ...
   private static class class_1188 implements class_94 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_3752;

      class_1188(IBinder var1) {
      ...
      public boolean onMyLocationButtonClick() throws RemoteException {
         ...
         try {
            ...
            this.field_3752.transact(1, var2, var3, 0);
            var3.readException();
            var6 = var3.readInt();
            var8 = false;
         } finally {
