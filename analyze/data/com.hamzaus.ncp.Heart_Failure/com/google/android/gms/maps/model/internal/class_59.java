...
public interface class_59 extends IInterface {
   ...
   boolean method_328(class_59 var1) throws RemoteException;
   ...
   public abstract static class class_1156 extends Binder implements class_59 {
      // $FF: renamed from: bb (android.os.IBinder) com.google.android.gms.maps.model.internal.e
      public static class_59 method_3669(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
            return (class_59)(var1 != null && var1 instanceof class_59?(class_59)var1:new class_59.class_1157(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 4:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
            boolean var6 = this.a(method_3669(var2.readStrongBinder()));
            var3.writeNoException();
            byte var7;
            if(var6) {
               var7 = 1;
   ...
   private static class class_1157 implements class_59 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_3121;
      ...
      // $FF: renamed from: a (com.google.android.gms.maps.model.internal.e) boolean
      public boolean method_328(class_59 param1) throws RemoteException {
      ...
      public void activate() throws RemoteException {
         ...
         try {
            ...
            this.field_3121.transact(3, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public String getName() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
            this.field_3121.transact(1, var1, var2, 0);
            var2.readException();
      ...
      public String getShortName() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
            this.field_3121.transact(2, var1, var2, 0);
            var2.readException();
            var5 = var2.readString();
         } finally {
            var2.recycle();
      ...
      public int hashCodeRemote() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
            this.field_3121.transact(5, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
