...
public interface IStreetViewPanoramaViewDelegate extends IInterface {
   ...
   public abstract static class class_1199 extends Binder implements IStreetViewPanoramaViewDelegate {
      // $FF: renamed from: aV (android.os.IBinder) com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate
      public static IStreetViewPanoramaViewDelegate method_4122(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            return (IStreetViewPanoramaViewDelegate)(var1 != null && var1 instanceof IStreetViewPanoramaViewDelegate?(IStreetViewPanoramaViewDelegate)var1:new IStreetViewPanoramaViewDelegate.class_1200(var0));
         }
      }
   ...
   private static class class_1200 implements IStreetViewPanoramaViewDelegate {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_3215;
      ...
      public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
         ...
         try {
            ...
            this.field_3215.transact(1, var1, var2, 0);
            var2.readException();
      ...
      public class_157 getView() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3215.transact(8, var1, var2, 0);
            var2.readException();
      ...
      public void onDestroy() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3215.transact(5, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onLowMemory() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3215.transact(6, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onPause() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3215.transact(4, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onResume() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3215.transact(3, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
