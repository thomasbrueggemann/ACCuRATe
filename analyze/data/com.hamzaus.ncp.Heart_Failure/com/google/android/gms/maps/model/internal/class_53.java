...
public interface class_53 extends IInterface {
   ...
   boolean method_253(class_53 var1) throws RemoteException;
   ...
   public abstract static class class_802 extends Binder implements class_53 {
      // $FF: renamed from: bf (android.os.IBinder) com.google.android.gms.maps.model.internal.h
      public static class_53 method_1299(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            return (class_53)(var1 != null && var1 instanceof class_53?(class_53)var1:new class_53.class_803(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 8:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            boolean var10 = this.a(method_1299(var2.readStrongBinder()));
            var3.writeNoException();
            byte var11 = 0;
            if(var10) {
               var11 = 1;
   ...
   private static class class_803 implements class_53 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_4242;

      class_803(IBinder var1) {
         this.field_4242 = var1;
      }

      // $FF: renamed from: a (com.google.android.gms.maps.model.internal.h) boolean
      public boolean method_253(class_53 param1) throws RemoteException {
      ...
      public void clearTileCache() throws RemoteException {
         ...
         try {
            ...
            this.field_4242.transact(2, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public boolean getFadeIn() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4242.transact(11, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public String getId() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4242.transact(3, var1, var2, 0);
            var2.readException();
      ...
      public float getZIndex() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4242.transact(5, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public int hashCodeRemote() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4242.transact(9, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public boolean isVisible() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4242.transact(7, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public void remove() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4242.transact(1, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void setZIndex(float var1) throws RemoteException {
         ...
         try {
            ...
            this.field_4242.transact(4, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
