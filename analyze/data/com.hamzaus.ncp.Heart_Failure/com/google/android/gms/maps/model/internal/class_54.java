...
public interface class_54 extends IInterface {
   ...
   public abstract static class class_1319 extends Binder implements class_54 {
      public class_1319() {
         this.attachInterface(this, "com.google.android.gms.maps.model.internal.ITileProviderDelegate");
      }

      // $FF: renamed from: bg (android.os.IBinder) com.google.android.gms.maps.model.internal.i
      public static class_54 method_2709(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileProviderDelegate");
            return (class_54)(var1 != null && var1 instanceof class_54?(class_54)var1:new class_54.class_1320(var0));
         }
      }
   ...
   private static class class_1320 implements class_54 {
      // $FF: renamed from: ko android.os.IBinder
      private IBinder field_3936;

      class_1320(IBinder var1) {
         ...
         label42: {
            ...
            label41: {
               try {
                  ...
                  var4.writeInt(var2);
                  var4.writeInt(var3);
                  this.field_3936.transact(1, var4, var5, 0);
                  var5.readException();
                  if(var5.readInt() != 0) {
                     var9 = Tile.CREATOR.createFromParcel(var5);
                     var11 = false;
                     break label41;
                  }
