...
public interface MetadataField<T> {
   ...
   T method_210(DataHolder var1, int var2, int var3);
   ...
   void method_211(DataHolder var1, MetadataBundle var2, int var3, int var4);

   // $FF: renamed from: a (java.lang.Object, android.os.Bundle) void
   void method_212(T var1, Bundle var2);

   // $FF: renamed from: e (android.os.Bundle) java.lang.Object
   T method_213(Bundle var1);

   String getName();

   // $FF: renamed from: gx () java.util.Collection
   Collection<String> method_214();
}
