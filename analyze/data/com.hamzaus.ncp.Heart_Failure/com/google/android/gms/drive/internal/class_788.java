...
public class class_788 implements Creator<OnMetadataResponse> {
   // $FF: renamed from: a (com.google.android.gms.drive.internal.OnMetadataResponse, android.os.Parcel, int) void
   static void method_4401(OnMetadataResponse var0, Parcel var1, int var2) {
      int var3 = class_599.method_3354(var1);
      class_599.method_3381(var1, 1, var0.field_4368);
      class_599.method_3365(var1, 2, var0.field_4367, var2, false);
      class_599.method_3357(var1, var3);
   }

   // $FF: renamed from: an (android.os.Parcel) com.google.android.gms.drive.internal.OnMetadataResponse
   public OnMetadataResponse method_4402(Parcel var1) {
   ...
   // $FF: renamed from: bj (int) com.google.android.gms.drive.internal.OnMetadataResponse[]
   public OnMetadataResponse[] method_4403(int var1) {
      return new OnMetadataResponse[var1];
   }

   // $FF: synthetic method
   public Object createFromParcel(Parcel var1) {
      return this.method_4402(var1);
   }

   // $FF: synthetic method
   public Object[] newArray(int var1) {
      return this.method_4403(var1);
   }
}
