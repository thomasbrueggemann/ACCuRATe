...
public final class PublisherAdView extends ViewGroup {
   ...
   private final class_169 field_3712;

   public PublisherAdView(Context var1) {
      super(var1);
      this.field_3712 = new class_169(this);
   }

   public PublisherAdView(Context var1, AttributeSet var2) {
      super(var1, var2);
      this.field_3712 = new class_169(this, var2, true);
   }
   ...
   public void destroy() {
      this.field_3712.destroy();
   }

   public AdListener getAdListener() {
      return this.field_3712.getAdListener();
   }

   public AdSize getAdSize() {
      return this.field_3712.getAdSize();
   }

   public AdSize[] getAdSizes() {
      return this.field_3712.getAdSizes();
   }

   public String getAdUnitId() {
      return this.field_3712.getAdUnitId();
   }

   public AppEventListener getAppEventListener() {
      return this.field_3712.getAppEventListener();
   }

   public void loadAd(PublisherAdRequest var1) {
      this.field_3712.method_1259(var1.method_4100());
   }
   ...
   public void pause() {
      this.field_3712.pause();
   }

   public void recordManualImpression() {
      this.field_3712.recordManualImpression();
   }

   public void resume() {
      this.field_3712.resume();
   }

   public void setAdListener(AdListener var1) {
      this.field_3712.setAdListener(var1);
   }

   public void setAdSizes(AdSize... var1) {
      if(var1 != null && var1.length >= 1) {
         this.field_3712.method_1260(var1);
      } else {
   ...
   public void setAdUnitId(String var1) {
      this.field_3712.setAdUnitId(var1);
   }

   public void setAppEventListener(AppEventListener var1) {
      this.field_3712.setAppEventListener(var1);
   }
}
