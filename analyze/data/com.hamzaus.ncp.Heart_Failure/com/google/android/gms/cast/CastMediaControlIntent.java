...
public final class CastMediaControlIntent {
   ...
   private static String method_3443(String var0, String var1, Collection<String> var2) throws IllegalArgumentException {
      StringBuffer var3 = new StringBuffer(var0);
      if(var1 != null) {
         if(!var1.matches("[A-F0-9]+") && !var1.equals("00000000-0000-0000-0000-000000000000")) {
   ...
   public static String categoryForCast(String var0) throws IllegalArgumentException {
      if(var0 == null) {
         ...
         return method_3443("com.google.android.gms.cast.CATEGORY_CAST", var0, (Collection)null);
      }
   }
   ...
   public static String categoryForCast(String var0, Collection<String> var1) {
      if(var0 == null) {
         ...
         return method_3443("com.google.android.gms.cast.CATEGORY_CAST", var0, var1);
      }
   }
   ...
   public static String categoryForCast(Collection<String> var0) throws IllegalArgumentException {
      if(var0 == null) {
         ...
         return method_3443("com.google.android.gms.cast.CATEGORY_CAST", (String)null, var0);
      }
   }

   public static String categoryForRemotePlayback() {
      return method_3443("com.google.android.gms.cast.CATEGORY_CAST_REMOTE_PLAYBACK", (String)null, (Collection)null);
   }
   ...
   public static String categoryForRemotePlayback(String var0) throws IllegalArgumentException {
      if(TextUtils.isEmpty(var0)) {
         ...
         return method_3443("com.google.android.gms.cast.CATEGORY_CAST_REMOTE_PLAYBACK", var0, (Collection)null);
      }
   }

   public static String languageTagForLocale(Locale var0) {
      return class_332.method_2121(var0);
   }
}
