...
public final class NotificationsImpl implements Notifications {
   public void clear(GoogleApiClient var1, int var2) {
      Games.method_2780(var1).method_1584(var2);
   }
   ...
   private abstract static class ContactSettingLoadImpl extends Games.BaseGamesApiMethodImpl<Notifications.ContactSettingLoadResult> {
      // $FF: renamed from: M (com.google.android.gms.common.api.Status) com.google.android.gms.games.Notifications$ContactSettingLoadResult
      public Notifications.ContactSettingLoadResult method_1148(final Status var1) {
   ...
   private abstract static class ContactSettingUpdateImpl extends Games.BaseGamesApiMethodImpl<Status> {
      ...
      // $FF: synthetic method
      public Result method_884(Status var1) {
         return this.method_1064(var1);
      }

      // $FF: renamed from: d (com.google.android.gms.common.api.Status) com.google.android.gms.common.api.Status
      public Status method_1064(Status var1) {
         return var1;
      }
   }

   private abstract static class InboxCountImpl extends Games.BaseGamesApiMethodImpl<Notifications.InboxCountResult> {
      // $FF: renamed from: N (com.google.android.gms.common.api.Status) com.google.android.gms.games.Notifications$InboxCountResult
      public Notifications.InboxCountResult method_1135(final Status var1) {
