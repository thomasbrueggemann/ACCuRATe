...
public final class RoomRef extends class_206 implements Room {
   // $FF: renamed from: RD int
   private final int field_683;
   ...
   public boolean equals(Object var1) {
      return RoomEntity.method_2210(this, var1);
   }
   ...
   public Participant getParticipant(String var1) {
      return RoomEntity.method_2215(this, var1);
   }

   public String getParticipantId(String var1) {
      return RoomEntity.method_2213(this, var1);
   }

   public ArrayList<String> getParticipantIds() {
      return RoomEntity.method_2216(this);
   }

   public int getParticipantStatus(String var1) {
      return RoomEntity.method_2209(this, var1);
   }

   public ArrayList<Participant> getParticipants() {
      ArrayList var1 = new ArrayList(this.field_683);

      for(int var2 = 0; var2 < this.field_683; ++var2) {
   ...
   public int hashCode() {
      return RoomEntity.method_2208(this);
   }

   public String toString() {
      return RoomEntity.method_2212(this);
   }
