...
public interface Person extends Freezable<Person> {
   ...
   public interface AgeRange extends Freezable<Person.AgeRange> {
      int getMax();
   ...
   public interface Cover extends Freezable<Person.Cover> {
   ...
   public interface CoverInfo extends Freezable<Person.CoverInfo> {
   ...
   public interface CoverPhoto extends Freezable<Person.CoverPhoto> {
      int getHeight();
   ...
   public interface Image extends Freezable<Person.Image> {
      String getUrl();

      boolean hasUrl();
   }

   public interface Name extends Freezable<Person.Name> {
   ...
   public interface Organizations extends Freezable<Person.Organizations> {
   ...
   public interface PlacesLived extends Freezable<Person.PlacesLived> {
      String getValue();
   ...
   public interface Urls extends Freezable<Person.Urls> {
      String getLabel();
