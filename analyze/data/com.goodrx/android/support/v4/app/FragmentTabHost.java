...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
   ...
   private void ensureHierarchy(Context var1) {
      if(this.findViewById(16908307) == null) {
         ...
         var4.setId(16908305);
         var2.addView(var4, new android.widget.LinearLayout.LayoutParams(0, 0, 0.0F));
         FrameLayout var5 = new FrameLayout(var1);
         this.mRealTabContent = var5;
         this.mRealTabContent.setId(this.mContainerId);
         var2.addView(var5, new android.widget.LinearLayout.LayoutParams(-1, 0, 1.0F));
      }
