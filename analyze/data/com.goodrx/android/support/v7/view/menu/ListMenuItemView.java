...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
   ...
   public ListMenuItemView(Context var1, AttributeSet var2, int var3) {
      super(var1, var2);
      this.mContext = var1;
      TypedArray var4 = var1.obtainStyledAttributes(var2, class_22.styleable.MenuView, var3, 0);
      this.mBackground = var4.getDrawable(class_22.styleable.MenuView_android_itemBackground);
      this.mTextAppearance = var4.getResourceId(class_22.styleable.MenuView_android_itemTextAppearance, -1);
      this.mPreserveIconSpacing = var4.getBoolean(class_22.styleable.MenuView_preserveIconSpacing, false);
   ...
   private void insertCheckBox() {
      this.mCheckBox = (CheckBox)this.getInflater().inflate(class_22.layout.abc_list_menu_item_checkbox, this, false);
      this.addView(this.mCheckBox);
   }

   private void insertIconView() {
      this.mIconView = (ImageView)this.getInflater().inflate(class_22.layout.abc_list_menu_item_icon, this, false);
      this.addView(this.mIconView, 0);
   }

   private void insertRadioButton() {
      this.mRadioButton = (RadioButton)this.getInflater().inflate(class_22.layout.abc_list_menu_item_radio, this, false);
   ...
   protected void onFinishInflate() {
      ...
      this.mTitleView = (TextView)this.findViewById(class_22.class_93.title);
      if(this.mTextAppearance != -1) {
         this.mTitleView.setTextAppearance(this.mTextAppearanceContext, this.mTextAppearance);
      }

      this.mShortcutView = (TextView)this.findViewById(class_22.class_93.shortcut);
   }
