   ...
   private class MenuState {
      ...
      private <T> T newInstance(String var1, Class<?>[] var2, Object[] var3) {
         try {
            ...
            Log.w("SupportMenuInflater", "Cannot instantiate class: " + var1, var8);
            return null;
         }
      }
      ...
      public void readGroup(AttributeSet var1) {
         TypedArray var2 = SupportMenuInflater.this.mContext.obtainStyledAttributes(var1, class_22.styleable.MenuGroup);
         this.groupId = var2.getResourceId(class_22.styleable.MenuGroup_android_id, 0);
         this.groupCategory = var2.getInt(class_22.styleable.MenuGroup_android_menuCategory, 0);
         this.groupOrder = var2.getInt(class_22.styleable.MenuGroup_android_orderInCategory, 0);
         this.groupCheckable = var2.getInt(class_22.styleable.MenuGroup_android_checkableBehavior, 0);
         this.groupVisible = var2.getBoolean(class_22.styleable.MenuGroup_android_visible, true);
         this.groupEnabled = var2.getBoolean(class_22.styleable.MenuGroup_android_enabled, true);
         var2.recycle();
      }

      public void readItem(AttributeSet var1) {
         TypedArray var2 = SupportMenuInflater.this.mContext.obtainStyledAttributes(var1, class_22.styleable.MenuItem);
         this.itemId = var2.getResourceId(class_22.styleable.MenuItem_android_id, 0);
         int var3 = var2.getInt(class_22.styleable.MenuItem_android_menuCategory, this.groupCategory);
         int var4 = var2.getInt(class_22.styleable.MenuItem_android_orderInCategory, this.groupOrder);
         this.itemCategoryOrder = -65536 & var3 | '\uffff' & var4;
         this.itemTitle = var2.getText(class_22.styleable.MenuItem_android_title);
         this.itemTitleCondensed = var2.getText(class_22.styleable.MenuItem_android_titleCondensed);
         this.itemIconResId = var2.getResourceId(class_22.styleable.MenuItem_android_icon, 0);
         this.itemAlphabeticShortcut = this.getShortcut(var2.getString(class_22.styleable.MenuItem_android_alphabeticShortcut));
         this.itemNumericShortcut = this.getShortcut(var2.getString(class_22.styleable.MenuItem_android_numericShortcut));
         if(var2.hasValue(class_22.styleable.MenuItem_android_checkable)) {
            byte var7;
            if(var2.getBoolean(class_22.styleable.MenuItem_android_checkable, false)) {
               var7 = 1;
            } else {
               var7 = 0;
            }
         ...
         this.itemChecked = var2.getBoolean(class_22.styleable.MenuItem_android_checked, false);
         this.itemVisible = var2.getBoolean(class_22.styleable.MenuItem_android_visible, this.groupVisible);
         this.itemEnabled = var2.getBoolean(class_22.styleable.MenuItem_android_enabled, this.groupEnabled);
         this.itemShowAsAction = var2.getInt(class_22.styleable.MenuItem_showAsAction, -1);
         this.itemListenerMethodName = var2.getString(class_22.styleable.MenuItem_android_onClick);
         this.itemActionViewLayout = var2.getResourceId(class_22.styleable.MenuItem_actionLayout, 0);
         this.itemActionViewClassName = var2.getString(class_22.styleable.MenuItem_actionViewClass);
         this.itemActionProviderClassName = var2.getString(class_22.styleable.MenuItem_actionProviderClass);
         boolean var5;
