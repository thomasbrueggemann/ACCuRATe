...
public abstract class LinearSmoothScroller extends RecyclerView.SmoothScroller {
   ...
   protected void onTargetFound(View var1, RecyclerView.State var2, RecyclerView.Action var3) {
   ...
   protected void updateActionForInterimTarget(RecyclerView.Action var1) {
      ...
      if(var2 != null && (var2.x != 0.0F || var2.y != 0.0F)) {
         ...
         this.mInterimTargetDx = (int)(10000.0F * var2.x);
         this.mInterimTargetDy = (int)(10000.0F * var2.y);
         int var4 = this.calculateTimeForScrolling(10000);
         var1.update((int)(1.2F * (float)this.mInterimTargetDx), (int)(1.2F * (float)this.mInterimTargetDy), (int)(1.2F * (float)var4), this.mLinearInterpolator);
      } else {
