...
public class zzq implements Creator<DeleteResourceRequest> {
   static void zza(DeleteResourceRequest var0, Parcel var1, int var2) {
   ...
   public DeleteResourceRequest zzbm(Parcel var1) {
   ...
   public DeleteResourceRequest[] zzdd(int var1) {
