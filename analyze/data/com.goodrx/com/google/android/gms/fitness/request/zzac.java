...
public class zzac implements Creator<SessionUnregistrationRequest> {
   static void zza(SessionUnregistrationRequest var0, Parcel var1, int var2) {
   ...
   public SessionUnregistrationRequest zzdH(Parcel var1) {
      IBinder var2 = null;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new SessionUnregistrationRequest(var4, var5, var2);
      }
   }

   public SessionUnregistrationRequest[] zzfI(int var1) {
      return new SessionUnregistrationRequest[var1];
   }
}
