...
public class zza implements Creator<ApplicationStatus> {
   static void zza(ApplicationStatus var0, Parcel var1, int var2) {
      int var3 = zzb.zzav(var1);
      zzb.zzc(var1, 1, var0.getVersionCode());
      zzb.zza(var1, 2, (String)var0.zzoe(), false);
      zzb.zzI(var1, var3);
   }
   ...
   public ApplicationStatus zzad(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new ApplicationStatus(var3, var4);
      }
   }

   public ApplicationStatus[] zzbi(int var1) {
      return new ApplicationStatus[var1];
   }
}
