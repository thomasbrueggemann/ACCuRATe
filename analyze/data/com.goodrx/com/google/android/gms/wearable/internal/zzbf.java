...
public class zzbf implements Creator<PutDataResponse> {
   static void zza(PutDataResponse var0, Parcel var1, int var2) {
   ...
   public Object[] newArray(int var1) {
      return this.zzmi(var1);
   }

   public PutDataResponse zziE(Parcel var1) {
      int var2 = 0;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new PutDataResponse(var5, var2, var4);
      }
   }

   public PutDataResponse[] zzmi(int var1) {
      return new PutDataResponse[var1];
   }
}
