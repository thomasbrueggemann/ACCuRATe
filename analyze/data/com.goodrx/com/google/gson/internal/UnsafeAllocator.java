...
public abstract class UnsafeAllocator {
   public static UnsafeAllocator create() {
      try {
         ...
         try {
            Method var5 = ObjectStreamClass.class.getDeclaredMethod("getConstructorId", new Class[]{Class.class});
            var5.setAccessible(true);
            final int var6 = ((Integer)var5.invoke((Object)null, new Object[]{Object.class})).intValue();
            Class[] var7 = new Class[]{Class.class, Integer.TYPE};
            final Method var8 = ObjectStreamClass.class.getDeclaredMethod("newInstance", var7);
            var8.setAccessible(true);
            UnsafeAllocator var9 = new UnsafeAllocator() {
               public <T> T newInstance(Class<T> var1) throws Exception {
                  Method var2 = var8;
                  Object[] var3 = new Object[]{var1, Integer.valueOf(var6)};
            ...
            try {
               final Method var3 = ObjectInputStream.class.getDeclaredMethod("newInstance", new Class[]{Class.class, Class.class});
               var3.setAccessible(true);
               UnsafeAllocator var4 = new UnsafeAllocator() {
                  public <T> T newInstance(Class<T> var1) throws Exception {
                     return var3.invoke((Object)null, new Object[]{var1, Object.class});
                  }
               };
               return var4;
