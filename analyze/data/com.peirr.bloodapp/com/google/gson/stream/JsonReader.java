...
public class JsonReader implements Closeable {
   ...
   private boolean fillBuffer(int var1) throws IOException {
      ...
      boolean var4;
      while(true) {
         int var3 = this.field_11.read(var2, this.limit, var2.length - this.limit);
         var4 = false;
         if(var3 == -1) {
            break;
         }
   ...
   public double nextDouble() throws IOException {
      ...
      if(var1 == 15) {
         ...
         if(!this.lenient && (Double.isNaN(var3) || Double.isInfinite(var3))) {
            throw new MalformedJsonException("JSON forbids NaN and infinities: " + var3 + " at line " + this.getLineNumber() + " column " + this.getColumnNumber());
         } else {
   ...
   public int nextInt() throws IOException {
      ...
      if(var1 == 15) {
         int var8 = (int)this.peekedLong;
         if(this.peekedLong != (long)var8) {
         ...
         if(var1 == 16) {
            ...
            try {
               int var7 = Integer.parseInt(this.peekedString);
               this.peeked = 0;
               return var7;
   ...
   public long nextLong() throws IOException {
      ...
      if(var1 == 15) {
         ...
         if(var1 == 16) {
            ...
            try {
               long var8 = Long.parseLong(this.peekedString);
               this.peeked = 0;
               return var8;
