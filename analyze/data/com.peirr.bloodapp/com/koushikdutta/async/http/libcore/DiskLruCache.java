...
import com.koushikdutta.async.http.libcore.Streams;
...
public final class DiskLruCache implements Closeable {
   ...
   private static String inputStreamToString(InputStream var0) throws IOException {
      return Streams.readFully(new InputStreamReader(var0, Charsets.UTF_8));
   }
      ...
      if(var3 <= 0L) {
         ...
         if(var7.journalFile.exists()) {
            try {
               var7.readJournal();
               var7.processJournal();
               var7.journalWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(var7.journalFile, true), Charsets.US_ASCII));
               return var7;
            } catch (IOException var11) {
               System.out.println("DiskLruCache " + var0 + " is corrupt: " + var11.getMessage() + ", removing");
               var7.delete();
            }
         }
   ...
   public final class Editor {
      ...
      public void set(int var1, String var2) throws IOException {
         ...
         try {
            var10 = true;
            var4 = new OutputStreamWriter(this.newOutputStream(var1), Charsets.UTF_8);
            var10 = false;
         } finally {
            if(var10) {
   ...
   private final class Entry {
      ...
      private IOException invalidLengths(String[] var1) throws IOException {
         throw new IOException("unexpected journal line: " + java.util.Arrays.toString(var1));
      }
   ...
   public final class Snapshot implements Closeable {
      ...
      public void close() {
         ...
         for(int var3 = 0; var3 < var2; ++var3) {
            IoUtils.closeQuietly(var1[var3]);
         }
