...
public class JSONObjectParser implements AsyncParser<JSONObject> {
   public Future<JSONObject> parse(DataEmitter var1) {
      return (new TransformFuture() {
         protected void transform(String var1) throws Exception {
            this.setComplete(new JSONObject(var1));
         }
      }).from((new StringParser()).parse(var1));
   }

   public void write(DataSink var1, JSONObject var2, CompletedCallback var3) {
