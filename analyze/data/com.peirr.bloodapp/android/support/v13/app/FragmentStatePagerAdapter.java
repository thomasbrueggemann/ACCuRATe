...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
   ...
   public Object instantiateItem(ViewGroup var1, int var2) {
      ...
      if(this.mSavedState.size() > var2) {
         SavedState var7 = (SavedState)this.mSavedState.get(var2);
         if(var7 != null) {
      ...
      FragmentCompat.setMenuVisibility(var3, false);
      ...
      if(var1 != null) {
         ...
         if(var4 != null) {
            for(int var12 = 0; var12 < var4.length; ++var12) {
               this.mSavedState.add((SavedState)var4[var12]);
            }
         }
   ...
   public Parcelable saveState() {
      ...
      if(var1 > 0) {
         var2 = new Bundle();
         SavedState[] var3 = new SavedState[this.mSavedState.size()];
