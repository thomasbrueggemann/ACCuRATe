   ...
   static final class Reader implements FrameReader {
      ...
      private void readGoAway(FrameReader.Handler var1, int var2, int var3) throws IOException {
         if(var3 != 8) {
            ...
            int var4 = Integer.MAX_VALUE & this.field_16.readInt();
            int var5 = this.field_16.readInt();
      ...
      private void readHeaders(FrameReader.Handler var1, int var2, int var3) throws IOException {
         var1.headers(false, false, Integer.MAX_VALUE & this.field_16.readInt(), -1, -1, this.nameValueBlockReader.readNameValueBlock(var3 - 4), HeadersMode.SPDY_HEADERS);
      }
      ...
      private void readSettings(FrameReader.Handler var1, int var2, int var3) throws IOException {
         ...
         if(var3 != 4 + var5 * 8) {
            ...
            for(int var7 = 0; var7 < var5; ++var7) {
               int var8 = this.field_16.readInt();
               int var9 = this.field_16.readInt();
      ...
      private void readSynStream(FrameReader.Handler var1, int var2, int var3) throws IOException {
         int var4 = this.field_16.readInt();
         int var5 = this.field_16.readInt();
         short var6 = this.field_16.readShort();
      ...
      public void close() throws IOException {
         Util.closeAll(this.field_16, this.nameValueBlockReader);
      }

      public boolean nextFrame(FrameReader.Handler var1) throws IOException {
         int var3;
         try {
            var3 = this.field_16.readInt();
         ...
         if(var5) {
            ...
            if(var11 != 3) {
               ...
               case 16:
                  Util.skipByReading(this.field_16, (long)var7);
            ...
            var1.data(var10, var8, this.field_16, var7);
            return true;
         }
      }
