...
public final class SpdyStream {
   ...
   private final int field_19;
   // $FF: renamed from: in com.squareup.okhttp.internal.spdy.SpdyStream$SpdyDataInputStream
   private final SpdyStream.SpdyDataInputStream field_20 = new SpdyStream.SpdyDataInputStream();
   ...
   public void close(ErrorCode var1) throws IOException {
      if(this.closeInternal(var1)) {
         this.connection.writeSynReset(this.field_19, var1);
      }
   }

   public void closeLater(ErrorCode var1) {
      if(this.closeInternal(var1)) {
         this.connection.writeSynResetLater(this.field_19, var1);
      }
   }
   ...
   void receiveData(InputStream var1, int var2) throws IOException {
      if(!$assertionsDisabled && Thread.holdsLock(this)) {
         ...
         this.field_20.receive(var1, var2);
      }
   }
   ...
   void receiveWindowUpdate(int var1) {
      ...
      try {
         SpdyStream.SpdyDataOutputStream.access$620(this.out, var1);
         this.notifyAll();
      } finally {
         ;
      }
   ...
   private final class SpdyDataOutputStream extends OutputStream {
      ...
      // $FF: synthetic method
      static int access$620(SpdyStream.SpdyDataOutputStream var0, int var1) {
         int var2 = var0.unacknowledgedBytes - var1;
         var0.unacknowledgedBytes = var2;
         return var2;
      }
