...
public class CordovaWebView extends WebView {
   ...
   public void handlePause(boolean var1) {
      LOG.method_2("CordovaWebView", "Handle the pause");
   ...
   public void loadUrlIntoView(String var1, int var2) {
      if(!var1.startsWith("javascript:") && !this.canGoBack()) {
         ...
         LOG.method_4("CordovaWebView", "loadUrlIntoView(%s, %d)", var3);
   ...
   public void loadUrlIntoView(final String var1, boolean var2) {
      LOG.method_2("CordovaWebView", ">>> loadUrl(" + var1 + ")");
   ...
   void loadUrlNow(String var1) {
      if(LOG.isLoggable(3) && !var1.startsWith("javascript:")) {
         LOG.method_2("CordovaWebView", ">>> loadUrlNow()");
      }
   ...
   public void printBackForwardList() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ...
         LOG.method_2("CordovaWebView", "The URL at index: " + Integer.toString(var3) + " is " + var4);
      }
   ...
   public boolean startOfHistory() {
      ...
      if(var1 != null) {
         ...
         LOG.method_2("CordovaWebView", "The current URL is: " + var4);
         LOG.method_2("CordovaWebView", "The URL at item 0 is: " + var3);
