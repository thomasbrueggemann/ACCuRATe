...
public class LinearLayoutSoftKeyboardDetect extends LinearLayout {
   ...
   protected void onMeasure(int var1, int var2) {
      ...
      if(this.oldHeight != 0 && this.oldHeight != var3) {
         ...
         LOG.method_2("SoftKeyboardDetect", "Ignore this event");
      }
