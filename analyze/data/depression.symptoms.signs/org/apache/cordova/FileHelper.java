...
public class FileHelper {
   ...
   public static String getRealPath(String var0, CordovaInterface var1) {
      ...
      if(var0.startsWith("content://")) {
         ...
         if(var6 == null) {
            LOG.method_7("FileUtils", "Could get real path for URI string %s", new Object[]{var0});
         }
      } else {
         ...
         if(var6.startsWith("/android_asset/")) {
            LOG.method_7("FileUtils", "Cannot get real path for URI string %s because it is a file:///android_asset/ URI.", new Object[]{var0});
            return null;
         }
      }
