...
class DonutAnimatorCompatProvider implements AnimatorProvider {
   ...
   private static class DonutFloatValueAnimator implements ValueAnimatorCompat {
      ...
      private Runnable mLoopRunnable = new Runnable() {
         public void run() {
            float var1 = 1.0F * (float)(DonutFloatValueAnimator.this.getTime() - DonutFloatValueAnimator.this.mStartTime) / (float)DonutFloatValueAnimator.this.mDuration;
      ...
      private void dispatchCancel() {
         for(int var1 = -1 + this.mListeners.size(); var1 >= 0; --var1) {
      ...
      private void notifyUpdateListeners() {
         for(int var1 = -1 + this.mUpdateListeners.size(); var1 >= 0; --var1) {
