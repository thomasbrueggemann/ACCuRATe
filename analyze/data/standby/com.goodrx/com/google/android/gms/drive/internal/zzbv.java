...
public class zzbv implements Creator<StreamContentsRequest> {
   static void zza(StreamContentsRequest var0, Parcel var1, int var2) {
   ...
   public StreamContentsRequest zzbW(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new StreamContentsRequest(var3, var4);
      }
   }

   public StreamContentsRequest[] zzdR(int var1) {
      return new StreamContentsRequest[var1];
   }
}
