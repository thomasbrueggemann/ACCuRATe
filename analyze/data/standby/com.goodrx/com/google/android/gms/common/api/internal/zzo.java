...
public interface zzo extends IInterface {
   ...
   public abstract static class zza extends Binder implements zzo {
      public static zzo zzaN(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         switch(var1) {
         case 1:
            var2.enforceInterface("com.google.android.gms.common.api.internal.IStatusCallback");
            Status var5;
            if(var2.readInt() != 0) {
            ...
            return true;
         case 1598968902:
            var3.writeString("com.google.android.gms.common.api.internal.IStatusCallback");
            return true;
         default:
