...
public class zzak implements Creator<GetPermissionsRequest> {
   static void zza(GetPermissionsRequest var0, Parcel var1, int var2) {
   ...
   public GetPermissionsRequest zzbu(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new GetPermissionsRequest(var3, var4);
      }
   }

   public GetPermissionsRequest[] zzdp(int var1) {
      return new GetPermissionsRequest[var1];
   }
}
