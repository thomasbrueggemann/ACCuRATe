...
public class zza implements Creator<UserAddressRequest> {
   static void zza(UserAddressRequest var0, Parcel var1, int var2) {
      int var3 = zzb.zzav(var1);
      zzb.zzc(var1, 1, var0.getVersionCode());
      zzb.zzc(var1, 2, var0.zzaMA, false);
      zzb.zzI(var1, var3);
   }
   ...
   public UserAddressRequest zzeL(Parcel var1) {
      ...
      while(var1.dataPosition() < var2) {
         ...
         case 1:
            ...
            break;
         case 2:
            var4 = com.google.android.gms.common.internal.safeparcel.zza.zzc(var1, var5, CountrySpecification.CREATOR);
            break;
         default:
   ...
   public UserAddressRequest[] zzhi(int var1) {
