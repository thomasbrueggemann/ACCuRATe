...
public final class AdSize {
   ...
   private final com.google.android.gms.ads.AdSize field_3850;
   ...
   public boolean equals(Object var1) {
      if(!(var1 instanceof AdSize)) {
         ...
         return this.field_3850.equals(var2.field_3850);
      }
   }
   ...
   public int getHeight() {
      return this.field_3850.getHeight();
   }

   public int getHeightInPixels(Context var1) {
      return this.field_3850.getHeightInPixels(var1);
   }

   public int getWidth() {
      return this.field_3850.getWidth();
   }

   public int getWidthInPixels(Context var1) {
      return this.field_3850.getWidthInPixels(var1);
   }

   public int hashCode() {
      return this.field_3850.hashCode();
   }

   public boolean isAutoHeight() {
      return this.field_3850.isAutoHeight();
   }
   ...
   public boolean isFullWidth() {
      return this.field_3850.isFullWidth();
   }
   ...
   public String toString() {
      return this.field_3850.toString();
   }
}
