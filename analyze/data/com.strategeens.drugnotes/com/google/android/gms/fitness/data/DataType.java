...
import com.google.android.gms.fitness.data.class_1041;
...
public final class DataType implements SafeParcelable {
   ...
   // $FF: renamed from: Uq com.google.android.gms.fitness.data.DataType
   public static final DataType field_4255;
   // $FF: renamed from: Ur com.google.android.gms.fitness.data.DataType
   public static final DataType field_4256;
   // $FF: renamed from: Us java.util.Map
   private static final Map<DataType, List<DataType>> field_4257;
   // $FF: renamed from: Ut com.google.android.gms.fitness.data.DataType[]
   public static final DataType[] field_4258;
   // $FF: renamed from: Uu java.lang.String[]
   public static final String[] field_4259;
   // $FF: renamed from: CK int
   private final int field_4260;
   // $FF: renamed from: Uv java.util.List
   private final List<Field> field_4261;
   ...
   static {
      ...
      Field[] var8 = new Field[]{Field.FIELD_ACTIVITY, Field.field_3583};
      field_4255 = new DataType("com.google.activity.edge", var8);
      Field[] var9 = new Field[]{Field.field_3584, Field.field_3585, Field.field_3586};
      field_4256 = new DataType("com.google.accelerometer", var9);
   ...
   public boolean equals(Object var1) {
      return this == var1 || var1 instanceof DataType && this.method_5486((DataType)var1);
   }
   ...
   public int indexOf(Field var1) {
      if(this.field_4261.contains(var1)) {
         return this.field_4261.indexOf(var1);
      } else {
