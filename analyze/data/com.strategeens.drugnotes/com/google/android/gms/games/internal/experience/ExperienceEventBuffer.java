...
public final class ExperienceEventBuffer extends DataBuffer<ExperienceEvent> {
   ...
   // $FF: renamed from: ea (int) com.google.android.gms.games.internal.experience.ExperienceEvent
   public ExperienceEvent method_2979(int var1) {
      return new ExperienceEventRef(this.JG, var1);
   }

   // $FF: synthetic method
   public Object get(int var1) {
      return this.method_2979(var1);
   }
}
