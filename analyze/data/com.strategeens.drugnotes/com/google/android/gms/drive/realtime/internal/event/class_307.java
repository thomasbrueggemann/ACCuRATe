...
public class class_307 implements Creator<TextInsertedDetails> {
   // $FF: renamed from: a (com.google.android.gms.drive.realtime.internal.event.TextInsertedDetails, android.os.Parcel, int) void
   static void method_2178(TextInsertedDetails var0, Parcel var1, int var2) {
      int var3 = class_704.method_4025(var1);
      class_704.method_4050(var1, 1, var0.field_3793);
      class_704.method_4050(var1, 2, var0.mIndex);
      class_704.method_4050(var1, 3, var0.field_3794);
      class_704.method_4026(var1, var3);
   }

   // $FF: renamed from: bl (android.os.Parcel) com.google.android.gms.drive.realtime.internal.event.TextInsertedDetails
   public TextInsertedDetails method_2179(Parcel var1) {
      int var2 = 0;
   ...
   // $FF: renamed from: cB (int) com.google.android.gms.drive.realtime.internal.event.TextInsertedDetails[]
   public TextInsertedDetails[] method_2180(int var1) {
      return new TextInsertedDetails[var1];
   }

   // $FF: synthetic method
   public Object createFromParcel(Parcel var1) {
      return this.method_2179(var1);
   }
