...
public interface ItemScope extends Freezable<ItemScope> {
   ...
   public static class Builder {
      ...
      private String field_2637;
      // $FF: renamed from: UO java.lang.String
      private String field_2638;
      private double agg;
      private double agh;
      private String aoA;
      private class_728 aoB;
      private String aoC;
      private String aoD;
      private List<pd> aoE;
      private String aoF;
      ...
      private String aoL;
      private String aoM;
      private class_728 aoN;
      private String aoO;
      private String aoP;
      private String aoQ;
      private class_728 aoR;
      private class_728 aoS;
      private class_728 aoT;
      private List<pd> aoU;
      private String aoV;
      private String aoW;
      private String aoX;
      private String aoY;
      private class_728 aoZ;
      private final Set<Integer> aon = new HashSet();
      private class_728 aoo;
      private List<String> aop;
      private class_728 aoq;
      private String aor;
      private String aos;
      private String aot;
      private List<pd> aou;
      private int aov;
      private List<pd> aow;
      private class_728 aox;
      private List<pd> aoy;
      private String aoz;
      private String apa;
      private String apb;
      private String apc;
      private class_728 apd;
      private String ape;
      private String apf;
      private String apg;
      private String aph;
      ...
      private String field_2639;
      // $FF: renamed from: vc java.lang.String
      private String field_2640;
      // $FF: renamed from: vf java.lang.String
      private String field_2641;

      public ItemScope build() {
         return new class_728(this.aon, this.aoo, this.aop, this.aoq, this.aor, this.aos, this.aot, this.aou, this.aov, this.aow, this.aox, this.aoy, this.aoz, this.aoA, this.aoB, this.aoC, this.aoD, this.field_2639, this.aoE, this.aoF, this.aoG, this.aoH, this.field_2638, this.aoI, this.aoJ, this.aoK, this.aoL, this.aoM, this.aoN, this.aoO, this.aoP, this.field_2637, this.aoQ, this.aoR, this.agg, this.aoS, this.agh, this.mName, this.aoT, this.aoU, this.aoV, this.aoW, this.aoX, this.aoY, this.aoZ, this.apa, this.apb, this.apc, this.apd, this.ape, this.apf, this.field_2640, this.field_2641, this.apg, this.aph);
      }

      public ItemScope.Builder setAbout(ItemScope var1) {
         this.aoo = (class_728)var1;
