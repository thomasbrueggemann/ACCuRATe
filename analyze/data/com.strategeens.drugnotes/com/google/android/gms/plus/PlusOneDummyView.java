...
public class PlusOneDummyView extends FrameLayout {
   ...
   public PlusOneDummyView(Context var1, int var2) {
      ...
      var3.setBackgroundDrawable(this.method_5813().getDrawable(var2));
      Point var4 = this.method_5812(var2);
      this.addView(var3, new LayoutParams(var4.x, var4.y, 17));
   }

   // $FF: renamed from: fs (int) android.graphics.Point
   private Point method_5812(int var1) {
      byte var2 = 24;
      byte var3 = 20;
   ...
   // $FF: renamed from: ot () com.google.android.gms.plus.PlusOneDummyView$d
   private PlusOneDummyView.class_1630 method_5813() {
      Object var1 = new PlusOneDummyView.class_1632(this.getContext());
      if(!((PlusOneDummyView.class_1630)var1).isValid()) {
         var1 = new PlusOneDummyView.class_1633(this.getContext());
      }

      if(!((PlusOneDummyView.class_1630)var1).isValid()) {
         var1 = new PlusOneDummyView.class_1631(this.getContext());
      }

      return (PlusOneDummyView.class_1630)var1;
   }

   private static class class_1631 implements PlusOneDummyView.class_1630 {
      private Context mContext;

      private class_1631(Context var1) {
         this.mContext = var1;
      }

      // $FF: synthetic method
      class_1631(Context var1, Object var2) {
         this(var1);
      }
   ...
   private static class class_1632 implements PlusOneDummyView.class_1630 {
      private Context mContext;

      private class_1632(Context var1) {
         this.mContext = var1;
      }

      // $FF: synthetic method
      class_1632(Context var1, Object var2) {
         this(var1);
      }
   ...
   private static class class_1633 implements PlusOneDummyView.class_1630 {
      private Context mContext;

      private class_1633(Context var1) {
         this.mContext = var1;
      }

      // $FF: synthetic method
      class_1633(Context var1, Object var2) {
         this(var1);
      }
