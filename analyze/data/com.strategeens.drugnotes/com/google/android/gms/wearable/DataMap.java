...
public class DataMap {
   ...
   private static void method_5239(Bundle var0, String var1, Object var2) {
      if(var2 instanceof String) {
         ...
         if(var2 instanceof ArrayList) {
            switch(method_5245((ArrayList)var2)) {
            case 0:
   ...
   private static void method_5240(DataMap var0, String var1, Object var2) {
      if(var2 instanceof String) {
         var0.putString(var1, (String)var2);
      } else {
         if(var2 instanceof Integer) {
   ...
   private void method_5241(String var1, Object var2, String var3, ClassCastException var4) {
      this.method_5242(var1, var2, var3, "<null>", var4);
   }

   // $FF: renamed from: a (java.lang.String, java.lang.Object, java.lang.String, java.lang.Object, java.lang.ClassCastException) void
   private void method_5242(String var1, Object var2, String var3, Object var4, ClassCastException var5) {
   ...
   private static boolean method_5243(Asset var0, Asset var1) {
   ...
   private static boolean method_5244(DataMap var0, DataMap var1) {
                     ...
                     while(true) {
                        while(var2.hasNext()) {
                           ...
                           if(!(var4 instanceof Asset)) {
                              ...
                              if(!method_5243((Asset)var4, (Asset)var5)) {
                                 return false;
                              }
                           }
                        }
   ...
   private static int method_5245(ArrayList<?> var0) {
      if(var0.isEmpty()) {
         return 0;
      } else {
   ...
   public static DataMap fromBundle(Bundle var0) {
      ...
      while(var2.hasNext()) {
         String var3 = (String)var2.next();
         method_5240(var1, var3, var0.get(var3));
      }
   ...
   public static DataMap fromByteArray(byte[] var0) {
      try {
         DataMap var2 = class_823.method_4493(new class_823.class_1548(class_303.method_2127(var0), new ArrayList()));
         return var2;
      } catch (class_833 var3) {
   ...
   public boolean equals(Object var1) {
      return !(var1 instanceof DataMap)?false:method_5244(this, (DataMap)var1);
   }
   ...
   public Asset getAsset(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "Asset", var5);
            return null;
         }
      }
   }
   ...
   public boolean getBoolean(String var1, boolean var2) {
      ...
      if(var3 == null) {
         ...
         try {
            ...
            this.method_5242(var1, var3, "Boolean", Boolean.valueOf(var2), var6);
            return var2;
         }
      }
   }
   ...
   public byte getByte(String var1, byte var2) {
      ...
      if(var3 == null) {
         ...
         try {
            ...
            this.method_5242(var1, var3, "Byte", Byte.valueOf(var2), var6);
            return var2;
         }
      }
   }
   ...
   public byte[] getByteArray(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "byte[]", var5);
            return null;
         }
      }
   }
   ...
   public DataMap getDataMap(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "DataMap", var5);
            return null;
         }
      }
   }
   ...
   public ArrayList<DataMap> getDataMapArrayList(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "ArrayList<DataMap>", var5);
            return null;
         }
      }
   }
   ...
   public double getDouble(String var1, double var2) {
      ...
      if(var4 == null) {
         ...
         try {
            ...
            this.method_5242(var1, var4, "Double", Double.valueOf(var2), var8);
            return var2;
         }
      }
   }
   ...
   public float getFloat(String var1, float var2) {
      ...
      if(var3 == null) {
         ...
         try {
            ...
            this.method_5242(var1, var3, "Float", Float.valueOf(var2), var6);
            return var2;
         }
      }
   }
   ...
   public float[] getFloatArray(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "float[]", var5);
            return null;
         }
      }
   }
   ...
   public int getInt(String var1, int var2) {
      ...
      if(var3 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var3, "Integer", var6);
            return var2;
         }
      }
   }
   ...
   public ArrayList<Integer> getIntegerArrayList(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "ArrayList<Integer>", var5);
            return null;
         }
      }
   }
   ...
   public long getLong(String var1, long var2) {
      ...
      if(var4 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var4, "long", var8);
            return var2;
         }
      }
   }
   ...
   public long[] getLongArray(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "long[]", var5);
            return null;
         }
      }
   }
   ...
   public String getString(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "String", var5);
            return null;
         }
      }
   }
   ...
   public ArrayList<String> getStringArrayList(String var1) {
      ...
      if(var2 == null) {
         ...
         try {
            ...
            this.method_5241(var1, var2, "ArrayList<String>", var5);
            return null;
         }
      }
   }
   ...
   public Bundle toBundle() {
      ...
      while(var2.hasNext()) {
         String var3 = (String)var2.next();
         method_5239(var1, var3, this.axg.get(var3));
      }
   ...
   public byte[] toByteArray() {
      return class_300.method_2088(class_823.method_4491(this).ayo);
   }
