...
public class class_919 implements Creator<x> {
   // $FF: renamed from: a (com.google.android.gms.wearable.internal.x, android.os.Parcel, int) void
   static void method_5085(class_918 var0, Parcel var1, int var2) {
   ...
   public Object createFromParcel(Parcel var1) {
      return this.method_5086(var1);
   }

   // $FF: renamed from: ev (android.os.Parcel) com.google.android.gms.wearable.internal.x
   public class_918 method_5086(Parcel var1) {
      int var2 = 0;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new class_918(var5, var2, var4);
      }
   }

   // $FF: renamed from: gE (int) com.google.android.gms.wearable.internal.x[]
   public class_918[] method_5087(int var1) {
      return new class_918[var1];
   }
