...
// $FF: renamed from: com.google.android.gms.internal.qx
public final class class_832 {
   ...
   private static void method_4611(String var0, Object var1, StringBuffer var2, StringBuffer var3) throws IllegalAccessException, InvocationTargetException {
      if(var1 != null) {
         if(!(var1 instanceof class_300)) {
            String var4 = method_4614(var0);
            var3.append(var2).append(var4).append(": ");
            if(var1 instanceof String) {
               String var8 = method_4615((String)var1);
               var3.append("\"").append(var8).append("\"");
            } else if(var1 instanceof byte[]) {
               method_4612((byte[])((byte[])var1), var3);
            } else {
               var3.append(var1);
            }
         ...
         if(var0 != null) {
            var3.append(var2).append(method_4614(var0)).append(" <\n");
            var2.append("  ");
         }
            ...
            if((var26 & 1) == 1 && (var26 & 8) != 8 && !var27.startsWith("_") && !var27.endsWith("_")) {
               ...
               if(var28.isArray()) {
                  if(var28.getComponentType() == Byte.TYPE) {
                     method_4611(var27, var29, var2, var3);
                  } else {
                     int var30;
                     if(var29 == null) {
                        var30 = 0;
                     ...
                     for(int var31 = 0; var31 < var30; ++var31) {
                        method_4611(var27, Array.get(var29, var31), var2, var3);
                     }
                  }
               } else {
                  method_4611(var27, var29, var2, var3);
         ...
         for(int var17 = 0; var17 < var16; ++var17) {
            ...
            if(var19.startsWith("set")) {
               ...
               if(((Boolean)var22.invoke(var1, new Object[0])).booleanValue()) {
                  ...
                  method_4611(var20, var24.invoke(var1, new Object[0]), var2, var3);
               }
            }
         }
   ...
   private static void method_4612(byte[] var0, StringBuffer var1) {
      if(var0 == null) {
         var1.append("\"\"");
      } else {
         var1.append('\"');
   ...
   private static String method_4613(String var0) {
   ...
   // $FF: renamed from: dl (java.lang.String) java.lang.String
   private static String method_4614(String var0) {
   ...
   // $FF: renamed from: dm (java.lang.String) java.lang.String
   private static String method_4615(String var0) {
      if(!var0.startsWith("http") && var0.length() > 200) {
         var0 = var0.substring(0, 200) + "[...]";
      }

      return method_4613(var0);
   }

   // $FF: renamed from: g (com.google.android.gms.internal.qw) java.lang.String
   public static <T extends qw> String method_4616(T var0) {
      if(var0 == null) {
         return "";
      } else {
         StringBuffer var1 = new StringBuffer();
         ...
         try {
            method_4611((String)null, var0, new StringBuffer(), var1);
