...
public interface class_4 extends IInterface {
   ...
   public abstract static class class_1169 extends Binder implements class_4 {
      public class_1169() {
      ...
      public static class_4 method_1537(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (class_4)(var1 != null && var1 instanceof class_4?(class_4)var1:new class_4.class_1170(var0));
         }
      }
   ...
   private static class class_1170 implements class_4 {
      // $FF: renamed from: le android.os.IBinder
      private IBinder field_1728;

      class_1170(IBinder var1) {
         this.field_1728 = var1;
      }
      ...
      public void onAdClosed() throws RemoteException {
         ...
         try {
            ...
            this.field_1728.transact(1, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onAdFailedToLoad(int var1) throws RemoteException {
         ...
         try {
            ...
            var2.writeInt(var1);
            this.field_1728.transact(2, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void onAdLeftApplication() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
            this.field_1728.transact(3, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onAdLoaded() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
            this.field_1728.transact(4, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onAdOpened() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
            this.field_1728.transact(5, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
