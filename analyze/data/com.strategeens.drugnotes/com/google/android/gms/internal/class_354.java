...
@ey
public class class_354 extends WebChromeClient {
   // $FF: renamed from: mo com.google.android.gms.internal.gu
   private final class_371 field_1059;

   public class_354(class_371 var1) {
      this.field_1059 = var1;
   }

   // $FF: renamed from: a (android.app.AlertDialog.Builder, java.lang.String, android.webkit.JsResult) void
   private static void method_2438(Builder var0, String var1, final JsResult var2) {
   ...
   private static void method_2439(Context var0, Builder var1, String var2, String var3, final JsPromptResult var4) {
   ...
   private final Context method_2440(WebView var1) {
      Context var3;
      if(!(var1 instanceof class_371)) {
         var3 = var1.getContext();
      } else {
         class_371 var2 = (class_371)var1;
         var3 = var2.method_2536();
         if(var3 == null) {
   ...
   protected final void method_2441(View var1, int var2, CustomViewCallback var3) {
      class_464 var4 = this.field_1059.method_2530();
      if(var4 == null) {
         class_368.method_2506("Could not get ad overlay when showing custom view.");
         var3.onCustomViewHidden();
      } else {
         var4.method_2950(var1, var3);
   ...
   protected boolean method_2442(Context param1, String param2, String param3, String param4, JsResult param5, JsPromptResult param6, boolean param7) {
      // $FF: Couldn't be decompiled
   }

   public final void onCloseWindow(WebView var1) {
      if(!(var1 instanceof class_371)) {
         class_368.method_2506("Tried to close a WebView that wasn\'t an AdWebView.");
      } else {
         class_464 var2 = ((class_371)var1).method_2530();
         if(var2 == null) {
            class_368.method_2506("Tried to close an AdWebView not associated with an overlay.");
         } else {
            var2.close();
         }
      }
   ...
   public final boolean onConsoleMessage(ConsoleMessage var1) {
      ...
      if(var2.contains("Application Cache")) {
         ...
         switch(null.field_3595[var1.messageLevel().ordinal()]) {
         case 1:
            class_368.method_2503(var2);
            break;
         case 2:
            class_368.method_2506(var2);
            break;
         case 3:
         case 4:
            class_368.method_2504(var2);
            break;
         case 5:
            class_368.method_2502(var2);
            break;
         default:
            class_368.method_2504(var2);
         }
   ...
   public final boolean onCreateWindow(WebView var1, boolean var2, boolean var3, Message var4) {
      ...
      var6.setWebViewClient(this.field_1059.method_2531());
   ...
   public final void onHideCustomView() {
      class_464 var1 = this.field_1059.method_2530();
      if(var1 == null) {
         class_368.method_2506("Could not get ad overlay when hiding custom view.");
      } else {
         var1.method_2954();
      }
   }
   ...
   public final boolean onJsAlert(WebView var1, String var2, String var3, JsResult var4) {
      return this.method_2442(this.method_2440(var1), var2, var3, (String)null, var4, (JsPromptResult)null, false);
   }
   ...
   public final boolean onJsPrompt(WebView var1, String var2, String var3, String var4, JsPromptResult var5) {
      return this.method_2442(this.method_2440(var1), var2, var3, var4, (JsResult)null, var5, true);
   }
