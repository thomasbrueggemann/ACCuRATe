...
// $FF: renamed from: com.google.android.gms.maps.model.internal.n
public interface class_59 extends IInterface {
   // $FF: renamed from: a (com.google.android.gms.maps.model.internal.n) boolean
   boolean method_290(class_59 var1) throws RemoteException;
   ...
   public abstract static class class_1618 extends Binder implements class_59 {
      // $FF: renamed from: bD (android.os.IBinder) com.google.android.gms.maps.model.internal.n
      public static class_59 method_4763(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            return (class_59)(var1 != null && var1 instanceof class_59?(class_59)var1:new class_59.class_1619(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 8:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            boolean var10 = this.a(method_4763(var2.readStrongBinder()));
            var3.writeNoException();
            byte var11 = 0;
            if(var10) {
               var11 = 1;
   ...
   private static class class_1619 implements class_59 {
      // $FF: renamed from: le android.os.IBinder
      private IBinder field_4521;

      class_1619(IBinder var1) {
         this.field_4521 = var1;
      }

      // $FF: renamed from: a (com.google.android.gms.maps.model.internal.n) boolean
      public boolean method_290(class_59 param1) throws RemoteException {
         // $FF: Couldn't be decompiled
      }

      public IBinder asBinder() {
         return this.field_4521;
      }
      ...
      public void clearTileCache() throws RemoteException {
         ...
         try {
            ...
            this.field_4521.transact(2, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public boolean getFadeIn() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4521.transact(11, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public String getId() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4521.transact(3, var1, var2, 0);
            var2.readException();
      ...
      public float getZIndex() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4521.transact(5, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public int hashCodeRemote() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4521.transact(9, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public boolean isVisible() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4521.transact(7, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public void remove() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            this.field_4521.transact(1, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void setZIndex(float var1) throws RemoteException {
         ...
         try {
            ...
            this.field_4521.transact(4, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
