...
public interface IPolylineDelegate extends IInterface {
   ...
   public abstract static class class_1274 extends Binder implements IPolylineDelegate {
      // $FF: renamed from: bC (android.os.IBinder) com.google.android.gms.maps.model.internal.IPolylineDelegate
      public static IPolylineDelegate method_4124(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            return (IPolylineDelegate)(var1 != null && var1 instanceof IPolylineDelegate?(IPolylineDelegate)var1:new IPolylineDelegate.class_1275(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 15:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            boolean var6 = this.equalsRemote(method_4124(var2.readStrongBinder()));
            var3.writeNoException();
            byte var7 = 0;
            if(var6) {
               var7 = 1;
   ...
   private static class class_1275 implements IPolylineDelegate {
      // $FF: renamed from: le android.os.IBinder
      private IBinder field_4477;

      class_1275(IBinder var1) {
         this.field_4477 = var1;
      }

      public IBinder asBinder() {
         return this.field_4477;
      }
      ...
      public int getColor() throws RemoteException {
         ...
         try {
            ...
            this.field_4477.transact(8, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public String getId() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            this.field_4477.transact(2, var1, var2, 0);
            var2.readException();
      ...
      public List<LatLng> getPoints() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            this.field_4477.transact(4, var1, var2, 0);
            var2.readException();
      ...
      public float getWidth() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            this.field_4477.transact(6, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public float getZIndex() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            this.field_4477.transact(10, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public int hashCodeRemote() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            this.field_4477.transact(16, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public boolean isGeodesic() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            this.field_4477.transact(14, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public boolean isVisible() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            this.field_4477.transact(12, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public void remove() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            this.field_4477.transact(1, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void setColor(int var1) throws RemoteException {
         ...
         try {
            ...
            var2.writeInt(var1);
            this.field_4477.transact(7, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setPoints(List<LatLng> var1) throws RemoteException {
         ...
         try {
            ...
            this.field_4477.transact(3, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setWidth(float var1) throws RemoteException {
         ...
         try {
            ...
            this.field_4477.transact(5, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setZIndex(float var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            var2.writeFloat(var1);
            this.field_4477.transact(9, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
