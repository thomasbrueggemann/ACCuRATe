...
public interface IStreetViewPanoramaViewDelegate extends IInterface {
   ...
   public abstract static class class_1561 extends Binder implements IStreetViewPanoramaViewDelegate {
      // $FF: renamed from: bt (android.os.IBinder) com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate
      public static IStreetViewPanoramaViewDelegate method_5234(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            return (IStreetViewPanoramaViewDelegate)(var1 != null && var1 instanceof IStreetViewPanoramaViewDelegate?(IStreetViewPanoramaViewDelegate)var1:new IStreetViewPanoramaViewDelegate.class_1562(var0));
         }
      }
   ...
   private static class class_1562 implements IStreetViewPanoramaViewDelegate {
      // $FF: renamed from: le android.os.IBinder
      private IBinder field_3174;

      class_1562(IBinder var1) {
         this.field_3174 = var1;
      }

      public IBinder asBinder() {
         return this.field_3174;
      }
      ...
      public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
         ...
         try {
            ...
            this.field_3174.transact(1, var1, var2, 0);
            var2.readException();
      ...
      public class_198 getView() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3174.transact(8, var1, var2, 0);
            var2.readException();
      ...
      public void onDestroy() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3174.transact(5, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onLowMemory() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3174.transact(6, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onPause() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3174.transact(4, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void onResume() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
            this.field_3174.transact(3, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
