...
// $FF: renamed from: com.google.android.gms.maps.model.internal.m
public interface class_64 extends IInterface {
   // $FF: renamed from: a (com.google.android.gms.maps.model.internal.m) boolean
   boolean method_372(class_64 var1) throws RemoteException;
   ...
   public abstract static class class_1557 extends Binder implements class_64 {
      // $FF: renamed from: bB (android.os.IBinder) com.google.android.gms.maps.model.internal.m
      public static class_64 method_4119(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            return (class_64)(var1 != null && var1 instanceof class_64?(class_64)var1:new class_64.class_1558(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 19:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            boolean var6 = this.a(method_4119(var2.readStrongBinder()));
            var3.writeNoException();
            byte var7 = 0;
            if(var6) {
               var7 = 1;
   ...
   private static class class_1558 implements class_64 {
      // $FF: renamed from: le android.os.IBinder
      private IBinder field_4161;

      class_1558(IBinder var1) {
         this.field_4161 = var1;
      }

      // $FF: renamed from: a (com.google.android.gms.maps.model.internal.m) boolean
      public boolean method_372(class_64 param1) throws RemoteException {
      ...
      public int getFillColor() throws RemoteException {
         ...
         try {
            ...
            this.field_4161.transact(12, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public List getHoles() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(6, var1, var2, 0);
            var2.readException();
      ...
      public String getId() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(2, var1, var2, 0);
            var2.readException();
      ...
      public List<LatLng> getPoints() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(4, var1, var2, 0);
            var2.readException();
      ...
      public int getStrokeColor() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(10, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public float getStrokeWidth() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(8, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public float getZIndex() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(14, var1, var2, 0);
            var2.readException();
            var5 = var2.readFloat();
         } finally {
            var2.recycle();
      ...
      public int hashCodeRemote() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(20, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
         } finally {
            var2.recycle();
      ...
      public boolean isGeodesic() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(18, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public boolean isVisible() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(16, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public void remove() throws RemoteException {
         ...
         try {
            var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            this.field_4161.transact(1, var1, var2, 0);
            var2.readException();
         } finally {
            var2.recycle();
            var1.recycle();
      ...
      public void setFillColor(int var1) throws RemoteException {
         ...
         try {
            ...
            var2.writeInt(var1);
            this.field_4161.transact(11, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setHoles(List var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            var2.writeList(var1);
            this.field_4161.transact(5, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setPoints(List<LatLng> var1) throws RemoteException {
         ...
         try {
            ...
            this.field_4161.transact(3, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setStrokeColor(int var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            var2.writeInt(var1);
            this.field_4161.transact(9, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setStrokeWidth(float var1) throws RemoteException {
         ...
         try {
            ...
            this.field_4161.transact(7, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
      ...
      public void setZIndex(float var1) throws RemoteException {
         ...
         try {
            var2.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            var2.writeFloat(var1);
            this.field_4161.transact(13, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
