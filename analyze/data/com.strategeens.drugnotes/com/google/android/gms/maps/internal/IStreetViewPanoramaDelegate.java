...
public interface IStreetViewPanoramaDelegate extends IInterface {
   ...
   class_198 orientationToPoint(StreetViewPanoramaOrientation var1) throws RemoteException;

   StreetViewPanoramaOrientation pointToOrientation(class_198 var1) throws RemoteException;

   void setOnStreetViewPanoramaCameraChangeListener(class_108 var1) throws RemoteException;

   void setOnStreetViewPanoramaChangeListener(class_109 var1) throws RemoteException;

   void setOnStreetViewPanoramaClickListener(class_100 var1) throws RemoteException;
   ...
   public abstract static class class_1179 extends Binder implements IStreetViewPanoramaDelegate {
      // $FF: renamed from: br (android.os.IBinder) com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate
      public static IStreetViewPanoramaDelegate method_5177(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            return (IStreetViewPanoramaDelegate)(var1 != null && var1 instanceof IStreetViewPanoramaDelegate?(IStreetViewPanoramaDelegate)var1:new IStreetViewPanoramaDelegate.class_1180(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 9:
            ...
            if(var2.readInt() != 0) {
               var15 = StreetViewPanoramaCamera.CREATOR.method_5030(var2);
            } else {
               var15 = null;
            }
         ...
         case 12:
            ...
            LatLng var13 = null;
            if(var12 != 0) {
               var13 = LatLng.CREATOR.method_5012(var2);
            }
         ...
         case 15:
            var2.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            this.setOnStreetViewPanoramaChangeListener(class_109.class_1503.method_1635(var2.readStrongBinder()));
            var3.writeNoException();
            return true;
         case 16:
            var2.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            this.setOnStreetViewPanoramaCameraChangeListener(class_108.class_1142.method_1636(var2.readStrongBinder()));
            var3.writeNoException();
            return true;
         case 17:
            var2.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            this.setOnStreetViewPanoramaClickListener(class_100.class_1159.method_1633(var2.readStrongBinder()));
            var3.writeNoException();
            return true;
         case 18:
            var2.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            StreetViewPanoramaOrientation var8 = this.pointToOrientation(class_198.class_1672.method_5291(var2.readStrongBinder()));
            var3.writeNoException();
            if(var8 != null) {
               var3.writeInt(1);
         ...
         case 19:
            ...
            class_198 var6 = this.orientationToPoint(var5);
            var3.writeNoException();
            IBinder var7 = null;
            if(var6 != null) {
               var7 = var6.asBinder();
   ...
   private static class class_1180 implements IStreetViewPanoramaDelegate {
      // $FF: renamed from: le android.os.IBinder
      private IBinder field_3808;
         ...
         label42: {
            ...
            label41: {
               try {
                  ...
                  this.field_3808.transact(10, var1, var2, 0);
                  var2.readException();
                  if(var2.readInt() != 0) {
                     var6 = StreetViewPanoramaCamera.CREATOR.method_5030(var2);
                     var8 = false;
                     break label41;
                  }
         ...
         label42: {
            ...
            label41: {
               try {
                  var8 = true;
                  var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                  this.field_3808.transact(14, var1, var2, 0);
                  var2.readException();
                  if(var2.readInt() != 0) {
                     var6 = StreetViewPanoramaLocation.CREATOR.method_5026(var2);
                     var8 = false;
                     break label41;
                  }
      ...
      public boolean isPanningGesturesEnabled() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            this.field_3808.transact(6, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public boolean isStreetNamesEnabled() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            this.field_3808.transact(8, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public boolean isUserNavigationEnabled() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            this.field_3808.transact(7, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public boolean isZoomGesturesEnabled() throws RemoteException {
         ...
         try {
            var8 = true;
            var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            this.field_3808.transact(5, var1, var2, 0);
            var2.readException();
            var5 = var2.readInt();
            var8 = false;
         } finally {
      ...
      public class_198 orientationToPoint(StreetViewPanoramaOrientation param1) throws RemoteException {
         // $FF: Couldn't be decompiled
      }

      public StreetViewPanoramaOrientation pointToOrientation(class_198 param1) throws RemoteException {
         // $FF: Couldn't be decompiled
      }

      public void setOnStreetViewPanoramaCameraChangeListener(class_108 param1) throws RemoteException {
         // $FF: Couldn't be decompiled
      }

      public void setOnStreetViewPanoramaChangeListener(class_109 param1) throws RemoteException {
         // $FF: Couldn't be decompiled
      }

      public void setOnStreetViewPanoramaClickListener(class_100 param1) throws RemoteException {
         // $FF: Couldn't be decompiled
      }
      ...
      public void setPositionWithID(String var1) throws RemoteException {
         ...
         try {
            ...
            this.field_3808.transact(11, var2, var3, 0);
            var3.readException();
         } finally {
            var3.recycle();
            var2.recycle();
