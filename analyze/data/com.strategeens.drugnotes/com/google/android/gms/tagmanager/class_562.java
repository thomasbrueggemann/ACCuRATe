...
class class_562 extends class_561 {
   // $FF: renamed from: ID java.lang.String
   private static final String field_2664;
   private final Context mContext;

   static {
      field_2664 = class_520.field_2208.toString();
   }

   public class_562(Context var1) {
      super(field_2664, new String[0]);
      this.mContext = var1;
   }
   ...
   public class_57.class_1084 method_3446(Map<String, class_57.class_1084> var1) {
      String var2 = this.method_3451(this.mContext);
   ...
   protected String method_3451(Context var1) {
