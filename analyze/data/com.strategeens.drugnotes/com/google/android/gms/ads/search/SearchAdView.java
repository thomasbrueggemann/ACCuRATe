...
public final class SearchAdView extends ViewGroup {
   ...
   private final class_233 field_3986;

   public SearchAdView(Context var1) {
      super(var1);
      this.field_3986 = new class_233(this);
   }

   public SearchAdView(Context var1, AttributeSet var2) {
      super(var1, var2);
      this.field_3986 = new class_233(this, var2, false);
   }
   ...
   public void destroy() {
      this.field_3986.destroy();
   }

   public AdListener getAdListener() {
      return this.field_3986.getAdListener();
   }

   public AdSize getAdSize() {
      return this.field_3986.getAdSize();
   }

   public String getAdUnitId() {
      return this.field_3986.getAdUnitId();
   }

   public void loadAd(SearchAdRequest var1) {
      this.field_3986.method_1592(var1.method_3043());
   }
   ...
   public void pause() {
      this.field_3986.pause();
   }

   public void resume() {
      this.field_3986.resume();
   }

   public void setAdListener(AdListener var1) {
      this.field_3986.setAdListener(var1);
   }

   public void setAdSize(AdSize var1) {
      this.field_3986.setAdSizes(new AdSize[]{var1});
   }

   public void setAdUnitId(String var1) {
      this.field_3986.setAdUnitId(var1);
   }
}
