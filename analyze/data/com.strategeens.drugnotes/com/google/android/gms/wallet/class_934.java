...
public class class_934 implements Creator<FullWalletRequest> {
   // $FF: renamed from: a (com.google.android.gms.wallet.FullWalletRequest, android.os.Parcel, int) void
   static void method_5189(FullWalletRequest var0, Parcel var1, int var2) {
      ...
      class_704.method_4034(var1, 4, var0.auV, var2, false);
      class_704.method_4026(var1, var3);
   }

   // $FF: synthetic method
   public Object createFromParcel(Parcel var1) {
      return this.method_5190(var1);
   }

   // $FF: renamed from: dO (android.os.Parcel) com.google.android.gms.wallet.FullWalletRequest
   public FullWalletRequest method_5190(Parcel var1) {
      Cart var2 = null;
      ...
      while(var1.dataPosition() < var3) {
         ...
         case 3:
            ...
            break;
         case 4:
            var2 = (Cart)class_705.method_4061(var1, var7, Cart.CREATOR);
            break;
         default:
   ...
   // $FF: renamed from: fV (int) com.google.android.gms.wallet.FullWalletRequest[]
   public FullWalletRequest[] method_5191(int var1) {
      return new FullWalletRequest[var1];
   }

   // $FF: synthetic method
   public Object[] newArray(int var1) {
      return this.method_5191(var1);
   }
}
