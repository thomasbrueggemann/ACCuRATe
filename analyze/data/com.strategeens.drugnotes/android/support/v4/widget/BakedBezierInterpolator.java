...
final class BakedBezierInterpolator implements Interpolator {
   ...
   public float getInterpolation(float var1) {
      if(var1 >= 1.0F) {
         ...
         int var2 = Math.min((int)(var1 * (float)(-1 + VALUES.length)), -2 + VALUES.length);
         float var3 = (var1 - (float)var2 * STEP_SIZE) / STEP_SIZE;
         return VALUES[var2] + var3 * (VALUES[var2 + 1] - VALUES[var2]);
      }
   }
}
