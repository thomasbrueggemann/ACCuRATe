...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, Runnable {
   ...
   int mEnterAnim;
   int mExitAnim;
   BackStackRecord.class_1586 mHead;
   int mIndex = -1;
   ...
   int mPopEnterAnim;
   int mPopExitAnim;
   BackStackRecord.class_1586 mTail;
   int mTransition;
   ...
   private void doAddOp(int var1, Fragment var2, String var3, int var4) {
      ...
      BackStackRecord.class_1586 var5 = new BackStackRecord.class_1586();
      var5.cmd = var4;
      var5.fragment = var2;
      this.addOp(var5);
   }
   ...
   void addOp(BackStackRecord.class_1586 var1) {
      if(this.mHead == null) {
         this.mTail = var1;
         this.mHead = var1;
      } else {
   ...
   public FragmentTransaction attach(Fragment var1) {
      BackStackRecord.class_1586 var2 = new BackStackRecord.class_1586();
      var2.cmd = 7;
      var2.fragment = var1;
      this.addOp(var2);
      return this;
   ...
   void bumpBackStackNesting(int var1) {
      if(this.mAddToBackStack) {
         ...
         for(BackStackRecord.class_1586 var2 = this.mHead; var2 != null; var2 = var2.next) {
   ...
   public void dump(String var1, PrintWriter var2, boolean var3) {
      ...
      if(this.mHead != null) {
         ...
         String var4 = var1 + "    ";
         BackStackRecord.class_1586 var5 = this.mHead;
   ...
   public void popFromBackStack(boolean var1) {
      ...
      for(BackStackRecord.class_1586 var2 = this.mTail; var2 != null; var2 = var2.prev) {
         switch(var2.cmd) {
         case 1:
   ...
   public void run() {
      ...
      if(this.mAddToBackStack && this.mIndex < 0) {
         ...
         for(BackStackRecord.class_1586 var1 = this.mHead; var1 != null; var1 = var1.next) {
            switch(var1.cmd) {
            case 1:
   ...
   static final class class_1586 {
      int cmd;
      int enterAnim;
      int exitAnim;
      Fragment fragment;
      BackStackRecord.class_1586 next;
      int popEnterAnim;
      int popExitAnim;
      BackStackRecord.class_1586 prev;
