...
public class MutableDateTime extends BaseDateTime implements Serializable, Cloneable, ReadWritableDateTime {
   ...
   public void setZone(DateTimeZone var1) {
      ...
      if(var3.getZone() != var2) {
         this.setChronology(var3.withZone(var2));
      }
   ...
   public void setZoneRetainFields(DateTimeZone var1) {
      ...
      if(var2 != var3) {
         long var4 = var3.getMillisKeepLocal(var2, this.getMillis());
         this.setChronology(this.getChronology().withZone(var2));
         this.setMillis(var4);
      }
   }
