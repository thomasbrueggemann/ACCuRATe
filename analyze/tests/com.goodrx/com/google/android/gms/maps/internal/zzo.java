...
public interface zzo extends IInterface {
   void zza(IGoogleMapDelegate var1) throws RemoteException;
   ...
   public abstract static class zza extends Binder implements zzo {
      ...
      public static zzo zzcK(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapReadyCallback");
            return (zzo)(var1 != null && var1 instanceof zzo?(zzo)var1:new zzo.zza(var0));
         }
      }
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 1:
            ...
            this.zza(IGoogleMapDelegate.zza.zzcv(var2.readStrongBinder()));
   ...
   private static class zza implements zzo {
      ...
      public void zza(IGoogleMapDelegate param1) throws RemoteException {
