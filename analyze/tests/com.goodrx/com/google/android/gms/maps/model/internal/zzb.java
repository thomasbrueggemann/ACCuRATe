...
public interface zzb extends IInterface {
   ...
   boolean zza(zzb var1) throws RemoteException;

   public abstract static class zza extends Binder implements zzb {
      public static zzb zzde(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
      ...
      public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
         ...
         case 3:
            ...
            LatLng var19;
            if(var2.readInt() != 0) {
               var19 = LatLng.CREATOR.zzfz(var2);
            } else {
               var19 = null;
            }
         ...
         case 17:
            var2.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
            boolean var6 = this.zza(zzde(var2.readStrongBinder()));
            var3.writeNoException();
            byte var7 = 0;
            if(var6) {
               var7 = 1;
   ...
   private static class zza implements zzb {
      ...
      public void setRadius(double var1) throws RemoteException {
         ...
         try {
            ...
            this.zzoz.transact(5, var3, var4, 0);
            var4.readException();
         } finally {
            var4.recycle();
            var3.recycle();
      ...
      public boolean zza(zzb param1) throws RemoteException {
         // $FF: Couldn't be decompiled
      }
   }
}
