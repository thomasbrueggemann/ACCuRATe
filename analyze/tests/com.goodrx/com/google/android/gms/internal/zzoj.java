...
public interface zzoj extends IInterface {
   ...
   public abstract static class zza extends Binder implements zzoj {
      public static zzoj zzbE(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.fitness.internal.IDataTypeCallback");
            return (zzoj)(var1 != null && var1 instanceof zzoj?(zzoj)var1:new zzoj.zza(var0));
         }
      }
   ...
   private static class zza implements zzoj {
      ...
      public void zza(DataTypeResult param1) throws RemoteException {
