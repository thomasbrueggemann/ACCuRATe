...
public interface zzov extends IInterface {
   ...
   public abstract static class zza extends Binder implements zzov {
      public static zzov zzbQ(IBinder var0) {
         if(var0 == null) {
            return null;
         } else {
            IInterface var1 = var0.queryLocalInterface("com.google.android.gms.fitness.internal.ISessionStopCallback");
            return (zzov)(var1 != null && var1 instanceof zzov?(zzov)var1:new zzov.zza(var0));
         }
      }
   ...
   private static class zza implements zzov {
      ...
      public void zza(SessionStopResult param1) throws RemoteException {
