...
public class zzs implements Creator<ChannelSendFileResponse> {
   static void zza(ChannelSendFileResponse var0, Parcel var1, int var2) {
   ...
   public ChannelSendFileResponse zzii(Parcel var1) {
      int var2 = 0;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new ChannelSendFileResponse(var4, var2);
      }
   }

   public ChannelSendFileResponse[] zzlM(int var1) {
      return new ChannelSendFileResponse[var1];
   }
}
