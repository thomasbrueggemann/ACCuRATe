...
public class zzaj implements Creator<GetChannelInputStreamResponse> {
   static void zza(GetChannelInputStreamResponse var0, Parcel var1, int var2) {
   ...
   public GetChannelInputStreamResponse zzip(Parcel var1) {
      int var2 = 0;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new GetChannelInputStreamResponse(var5, var2, var4);
      }
   }

   public GetChannelInputStreamResponse[] zzlT(int var1) {
      return new GetChannelInputStreamResponse[var1];
   }
}
