...
public class zzg implements Creator<DataTypeResult> {
   static void zza(DataTypeResult var0, Parcel var1, int var2) {
      ...
      com.google.android.gms.common.internal.safeparcel.zzb.zza(var1, 3, (Parcelable)var0.getDataType(), var2, false);
   ...
   public DataTypeResult zzdT(Parcel var1) {
      DataType var2 = null;
      ...
      for(var5 = null; var1.dataPosition() < var3; var2 = var7) {
         ...
         case 1:
            ...
            break;
         case 3:
            var7 = (DataType)com.google.android.gms.common.internal.safeparcel.zza.zza(var1, var6, DataType.CREATOR);
            var8 = var5;
            var9 = var4;
            break;
         case 1000:
   ...
   public DataTypeResult[] zzfU(int var1) {
