...
public class zzn implements Creator<StringParcel> {
   static void zza(StringParcel var0, Parcel var1, int var2) {
      int var3 = zzb.zzav(var1);
      zzb.zzc(var1, 1, var0.mVersionCode);
      zzb.zza(var1, 2, (String)var0.zzxG, false);
      zzb.zzI(var1, var3);
   }
   ...
   public StringParcel[] zzK(int var1) {
      return new StringParcel[var1];
   }

   public StringParcel zzm(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new StringParcel(var3, var4);
      }
   }
}
