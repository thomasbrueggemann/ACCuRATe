...
public class zzp implements Creator<PaymentMethodToken> {
   static void zza(PaymentMethodToken var0, Parcel var1, int var2) {
      ...
      com.google.android.gms.common.internal.safeparcel.zzb.zza(var1, 3, (String)var0.zzbaW, false);
   ...
   public PaymentMethodToken zzhD(Parcel var1) {
      int var2 = 0;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new PaymentMethodToken(var5, var2, var4);
      }
   }

   public PaymentMethodToken[] zzlb(int var1) {
