...
public class zzc implements Creator<DisableTargetRequest> {
   static void zza(DisableTargetRequest var0, Parcel var1, int var2) {
   ...
   public DisableTargetRequest zzfS(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new DisableTargetRequest(var3, var4);
      }
   }

   public DisableTargetRequest[] zziO(int var1) {
      return new DisableTargetRequest[var1];
   }
}
