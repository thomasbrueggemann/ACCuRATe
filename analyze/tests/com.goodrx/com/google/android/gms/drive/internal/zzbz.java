...
public class zzbz implements Creator<UntrashResourceRequest> {
   static void zza(UntrashResourceRequest var0, Parcel var1, int var2) {
   ...
   public UntrashResourceRequest zzca(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new UntrashResourceRequest(var3, var4);
      }
   }

   public UntrashResourceRequest[] zzdV(int var1) {
      return new UntrashResourceRequest[var1];
   }
}
