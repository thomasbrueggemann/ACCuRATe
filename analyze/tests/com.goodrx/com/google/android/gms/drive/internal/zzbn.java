...
public class zzbn implements Creator<ParcelableTransferPreferences> {
   static void zza(ParcelableTransferPreferences var0, Parcel var1, int var2) {
      ...
      com.google.android.gms.common.internal.safeparcel.zzb.zza(var1, 4, var0.zzasA);
   ...
   public ParcelableTransferPreferences zzbP(Parcel var1) {
      boolean var2 = false;
      ...
      if(var1.dataPosition() != var3) {
         ...
         return new ParcelableTransferPreferences(var6, var5, var4, var2);
      }
   }

   public ParcelableTransferPreferences[] zzdK(int var1) {
      return new ParcelableTransferPreferences[var1];
   }
}
