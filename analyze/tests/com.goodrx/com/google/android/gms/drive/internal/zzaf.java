...
public class zzaf implements Creator<FetchThumbnailRequest> {
   static void zza(FetchThumbnailRequest var0, Parcel var1, int var2) {
   ...
   public FetchThumbnailRequest zzbp(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new FetchThumbnailRequest(var3, var4);
      }
   }

   public FetchThumbnailRequest[] zzdi(int var1) {
      return new FetchThumbnailRequest[var1];
   }
}
