...
public class zzbh implements Creator<OnResourceIdSetResponse> {
   static void zza(OnResourceIdSetResponse var0, Parcel var1, int var2) {
   ...
   public OnResourceIdSetResponse zzbK(Parcel var1) {
   ...
   public OnResourceIdSetResponse[] zzdF(int var1) {
