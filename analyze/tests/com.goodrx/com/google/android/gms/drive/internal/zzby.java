...
public class zzby implements Creator<UnsubscribeResourceRequest> {
   static void zza(UnsubscribeResourceRequest var0, Parcel var1, int var2) {
   ...
   public UnsubscribeResourceRequest zzbZ(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new UnsubscribeResourceRequest(var3, var4);
      }
   }

   public UnsubscribeResourceRequest[] zzdU(int var1) {
      return new UnsubscribeResourceRequest[var1];
   }
}
