...
public class zzbs implements Creator<SetPinnedDownloadPreferencesRequest> {
   static void zza(SetPinnedDownloadPreferencesRequest var0, Parcel var1, int var2) {
   ...
   public SetPinnedDownloadPreferencesRequest zzbU(Parcel var1) {
      ...
      if(var1.dataPosition() != var2) {
         ...
         return new SetPinnedDownloadPreferencesRequest(var3, var4);
      }
   }

   public SetPinnedDownloadPreferencesRequest[] zzdP(int var1) {
      return new SetPinnedDownloadPreferencesRequest[var1];
   }
}
