...
public abstract class StoreLocationView extends FrameLayout {
   public StoreLocationView(Context var1, final int var2, String var3, double var4) {
      super(var1);
      LayoutInflater.from(var1).inflate(2130968749, this);
      ...
      this.setOnClickListener(new OnClickListener() {
         public void onClick(View var1) {
            StoreLocationView.this.onClicked(var2);
         }
      });
   }
