...
public class HttpURLConnectionExtension extends HttpURLConnection {
   ...
   public HttpURLConnectionExtension(HttpURLConnection var1) {
      super(var1.getURL());
      this.impl = var1;
   ...
   private void addTransactionAndErrorData(TransactionState var1) {
      ...
      if(var2 != null) {
         ...
         if((long)var1.getStatusCode() >= 400L) {
            ...
            Measurements.addHttpError(var2.getUrl(), var2.getHttpMethod(), var2.getStatusCode(), var3.toString(), var5);
            return;
         }
      }
   ...
   public InputStream getInputStream() throws IOException {
      ...
      var2.addStreamCompleteListener(new StreamCompleteListener() {
         public void streamComplete(StreamCompleteEvent var1x) {
            if(!var1.isComplete()) {
               long var2 = (long)HttpURLConnectionExtension.this.impl.getContentLength();
               ...
               HttpURLConnectionExtension.this.addTransactionAndErrorData(var1);
            }
         ...
         public void streamError(StreamCompleteEvent var1x) {
            ...
            HttpURLConnectionExtension.this.error(var1x.getException());
         }
      });
      return var2;
   }
   ...
   public OutputStream getOutputStream() throws IOException {
      ...
      var2.addStreamCompleteListener(new StreamCompleteListener() {
         public void streamComplete(StreamCompleteEvent var1x) {
            if(!var1.isComplete()) {
               String var2 = HttpURLConnectionExtension.this.impl.getRequestProperty("content-length");
