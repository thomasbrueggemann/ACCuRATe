   ...
   final class LoaderInfo implements Loader.OnLoadCanceledListener<Object>, Loader.OnLoadCompleteListener<Object> {
      ...
      void callOnLoadFinished(Loader<Object> var1, Object var2) {
         if(this.mCallbacks != null) {
            FragmentHostCallback var3 = LoaderManagerImpl.this.mHost;
            String var4 = null;
            if(var3 != null) {
               var4 = LoaderManagerImpl.this.mHost.mFragmentManager.mNoTransactionsBecause;
            ...
            try {
               ...
               if(LoaderManagerImpl.this.mHost != null) {
                  LoaderManagerImpl.this.mHost.mFragmentManager.mNoTransactionsBecause = var4;
               }
      ...
      void destroy() {
         ...
         if(this.mCallbacks != null && this.mLoader != null && this.mHaveData && var1) {
            ...
            FragmentHostCallback var2 = LoaderManagerImpl.this.mHost;
            String var3 = null;
            if(var2 != null) {
