...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
   ...
   protected void onMeasure(int var1, int var2) {
      if(MeasureSpec.getMode(var1) != 1073741824) {
         ...
         int var6 = getChildMeasureSpec(var1, (int)(0.2F * (float)var5), -2);
         this.mPrevText.measure(var6, var4);
         this.mCurrText.measure(var6, var4);
         this.mNextText.measure(var6, var4);
         int var8;
         if(MeasureSpec.getMode(var2) == 1073741824) {
            var8 = MeasureSpec.getSize(var2);
         } else {
            int var7 = this.mCurrText.getMeasuredHeight();
            var8 = Math.max(this.getMinHeight(), var7 + var3);
         }

         this.setMeasuredDimension(var5, ViewCompat.resolveSizeAndState(var8, var2, ViewCompat.getMeasuredState(this.mCurrText) << 16));
      }
   }
   ...
   void updateText(int var1, PagerAdapter var2) {
      ...
      int var9 = MeasureSpec.makeMeasureSpec(Math.max(0, (int)(0.8F * (float)(this.getWidth() - this.getPaddingLeft() - this.getPaddingRight()))), Integer.MIN_VALUE);
      int var10 = MeasureSpec.makeMeasureSpec(Math.max(0, this.getHeight() - this.getPaddingTop() - this.getPaddingBottom()), Integer.MIN_VALUE);
      this.mPrevText.measure(var9, var10);
      this.mCurrText.measure(var9, var10);
      this.mNextText.measure(var9, var10);
