...
public class ViewDragHelper {
   ...
   public boolean shouldInterceptTouchEvent(MotionEvent var1) {
      ...
      switch(var2) {
      case 0:
         float var27 = var1.getX();
         float var28 = var1.getY();
         int var29 = MotionEventCompat.getPointerId(var1, 0);
         this.saveInitialMotion(var27, var28, var29);
         View var30 = this.findTopChildUnder((int)var27, (int)var28);
         if(var30 == this.mCapturedView && this.mDragState == 2) {
            this.tryCaptureViewForDrag(var30, var29);
         }

         int var31 = this.mInitialEdgesTouched[var29];
         if((var31 & this.mTrackingEdges) != 0) {
            this.mCallback.onEdgeTouched(var31 & this.mTrackingEdges, var29);
         }
         break;
      case 1:
      case 3:
      ...
      case 2:
         if(this.mInitialMotionX != null && this.mInitialMotionY != null) {
            ...
            for(int var5 = 0; var5 < var4; ++var5) {
               ...
               boolean var12;
               if(var11 != null && this.checkTouchSlop(var11, var9, var10)) {
                  var12 = true;
               } else {
                  var12 = false;
               }
               ...
               if(var12) {
                  int var13 = var11.getLeft();
                  int var14 = var13 + (int)var9;
                  int var15 = this.mCallback.clampViewPositionHorizontal(var11, var14, (int)var9);
                  int var16 = var11.getTop();
                  int var17 = var16 + (int)var10;
                  int var18 = this.mCallback.clampViewPositionVertical(var11, var17, (int)var10);
                  int var19 = this.mCallback.getViewHorizontalDragRange(var11);
                  int var20 = this.mCallback.getViewVerticalDragRange(var11);
                  if((var19 == 0 || var19 > 0 && var15 == var13) && (var20 == 0 || var20 > 0 && var18 == var16)) {
                     break;
                  }
               }

               this.reportNewEdgeDrags(var9, var10, var6);
               if(this.mDragState == 1 || var12 && this.tryCaptureViewForDrag(var11, var6)) {
                  break;
               }
            }
      ...
      default:
         break;
      case 5:
         int var21 = MotionEventCompat.getPointerId(var1, var3);
         float var22 = MotionEventCompat.getX(var1, var3);
         float var23 = MotionEventCompat.getY(var1, var3);
         this.saveInitialMotion(var22, var23, var21);
         if(this.mDragState == 0) {
            int var26 = this.mInitialEdgesTouched[var21];
            if((var26 & this.mTrackingEdges) != 0) {
               this.mCallback.onEdgeTouched(var26 & this.mTrackingEdges, var21);
            }
         } else if(this.mDragState == 2) {
            View var24 = this.findTopChildUnder((int)var22, (int)var23);
            if(var24 == this.mCapturedView) {
               this.tryCaptureViewForDrag(var24, var21);
            }
         }
         break;
      case 6:
