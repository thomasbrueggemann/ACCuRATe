...
public abstract class RoundedBitmapDrawable extends Drawable {
   ...
   void updateDstRect() {
      if(this.mApplyGravity) {
         if(this.mIsCircular) {
            int var3 = Math.min(this.mBitmapWidth, this.mBitmapHeight);
            this.gravityCompatApply(this.mGravity, var3, var3, this.getBounds(), this.mDstRect);
            int var4 = Math.min(this.mDstRect.width(), this.mDstRect.height());
            int var5 = Math.max(0, (this.mDstRect.width() - var4) / 2);
            int var6 = Math.max(0, (this.mDstRect.height() - var4) / 2);
            this.mDstRect.inset(var5, var6);
            this.mCornerRadius = 0.5F * (float)var4;
         } else {
