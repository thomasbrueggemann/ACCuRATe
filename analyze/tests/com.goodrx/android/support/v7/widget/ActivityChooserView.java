...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
   ...
   public ActivityChooserView(Context var1, AttributeSet var2, int var3) {
      ...
      TypedArray var4 = var1.obtainStyledAttributes(var2, class_22.styleable.ActivityChooserView, var3, 0);
      this.mInitialActivityCount = var4.getInt(class_22.styleable.ActivityChooserView_initialActivityCount, 4);
      Drawable var5 = var4.getDrawable(class_22.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
      var4.recycle();
      LayoutInflater.from(this.getContext()).inflate(class_22.layout.abc_activity_chooser_view, this, true);
      this.mCallbacks = new ActivityChooserView.Callbacks(null);
      this.mActivityChooserContent = (LinearLayoutCompat)this.findViewById(class_22.class_93.activity_chooser_view_content);
      this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
      this.mDefaultActivityButton = (FrameLayout)this.findViewById(class_22.class_93.default_activity_button);
      this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
      this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
      this.mDefaultActivityButtonImage = (ImageView)this.mDefaultActivityButton.findViewById(class_22.class_93.image);
      final FrameLayout var7 = (FrameLayout)this.findViewById(class_22.class_93.expand_activities_button);
      ...
      this.mExpandActivityOverflowButtonImage = (ImageView)var7.findViewById(class_22.class_93.image);
      ...
      this.mListPopupMaxWidth = Math.max(var8.getDisplayMetrics().widthPixels / 2, var8.getDimensionPixelSize(class_22.dimen.abc_config_prefDialogWidth));
   }
   ...
   private void showPopupUnchecked(int var1) {
      if(this.mAdapter.getDataModel() == null) {
         ...
         if(!var5.isShowing()) {
            ...
            var5.getListView().setContentDescription(this.getContext().getString(class_22.string.abc_activitychooserview_choose_application));
         }
   ...
   private class ActivityChooserViewAdapter extends BaseAdapter {
      ...
      public View getView(int var1, View var2, ViewGroup var3) {
         switch(this.getItemViewType(var1)) {
         case 0:
            if(var2 == null || var2.getId() != class_22.class_93.list_item) {
               var2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(class_22.layout.abc_activity_chooser_view_list_item, var3, false);
            }

            PackageManager var4 = ActivityChooserView.this.getContext().getPackageManager();
            ImageView var5 = (ImageView)var2.findViewById(class_22.class_93.icon);
            ResolveInfo var6 = (ResolveInfo)this.getItem(var1);
            var5.setImageDrawable(var6.loadIcon(var4));
            ((TextView)var2.findViewById(class_22.class_93.title)).setText(var6.loadLabel(var4));
            if(this.mShowDefaultActivity && var1 == 0 && this.mHighlightDefaultActivity) {
               ViewCompat.setActivated(var2, true);
            } else {
               ViewCompat.setActivated(var2, false);
            }
         ...
         case 1:
            if(var2 == null || var2.getId() != 1) {
               var2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(class_22.layout.abc_activity_chooser_view_list_item, var3, false);
               var2.setId(1);
               ((TextView)var2.findViewById(class_22.class_93.title)).setText(ActivityChooserView.this.getContext().getString(class_22.string.abc_activity_chooser_view_see_all));
            }
