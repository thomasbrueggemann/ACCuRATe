...
public class MenuBuilder implements SupportMenu {
   ...
   private void setShortcutsVisibleInner(boolean var1) {
      byte var2 = 1;
      if(!var1 || this.mResources.getConfiguration().keyboard == var2 || !this.mResources.getBoolean(class_22.bool.abc_config_showMenuShortcutsWhenKeyboardPresent)) {
         var2 = 0;
      }
      ...
      if(this.mIsActionItemsStale) {
         ...
         if(var2) {
            ...
            for(int var6 = 0; var6 < var5; ++var6) {
               MenuItemImpl var7 = (MenuItemImpl)var1.get(var6);
   ...
   public boolean performItemAction(MenuItem var1, MenuPresenter var2, int var3) {
      ...
      if(var4 != null && var4.isEnabled()) {
         var5 = var4.invoke();
         ActionProvider var6 = var4.getSupportActionProvider();
         boolean var7;
         if(var6 != null && var6.hasSubMenu()) {
            var7 = true;
         } else {
            var7 = false;
         }
         ...
         if(var4.hasCollapsibleActionView()) {
            ...
            SubMenuBuilder var8 = (SubMenuBuilder)var4.getSubMenu();
            if(var7) {
               var6.onPrepareSubMenu(var8);
            }

            var5 |= this.dispatchSubMenuSelected(var8, var2);
            if(!var5) {
               this.close(true);
               return var5;
            }
