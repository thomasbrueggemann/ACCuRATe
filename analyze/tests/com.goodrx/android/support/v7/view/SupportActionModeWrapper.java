   ...
   public static class CallbackWrapper implements ActionMode.Callback {
      ...
      public android.view.ActionMode getActionModeWrapper(ActionMode var1) {
         ...
         for(int var3 = this.mActionModes.size(); var2 < var3; ++var2) {
            SupportActionModeWrapper var6 = (SupportActionModeWrapper)this.mActionModes.get(var2);
            if(var6 != null && var6.mWrappedObject == var1) {
               return var6;
            }
         }

         SupportActionModeWrapper var4 = new SupportActionModeWrapper(this.mContext, var1);
         this.mActionModes.add(var4);
         return var4;
      }
