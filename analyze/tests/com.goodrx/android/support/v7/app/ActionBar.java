...
public abstract class ActionBar {
   ...
   public static class LayoutParams extends MarginLayoutParams {
      ...
      public LayoutParams(@NonNull Context var1, AttributeSet var2) {
         super(var1, var2);
         this.gravity = 0;
         TypedArray var3 = var1.obtainStyledAttributes(var2, class_22.styleable.ActionBarLayout);
         this.gravity = var3.getInt(class_22.styleable.ActionBarLayout_android_layout_gravity, 0);
         var3.recycle();
      }
