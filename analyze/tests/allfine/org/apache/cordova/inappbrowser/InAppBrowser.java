...
public class InAppBrowser extends CordovaPlugin {
    ...
    private void sendUpdate(JSONObject var1, boolean var2) {
        this.sendUpdate(var1, var2, PluginResult.Status.field_2155);
    }
    ...
    public boolean execute(String var1, CordovaArgs var2, final CallbackContext var3) throws JSONException {
        ...
        if(var1.equals("open")) {
            ...
            this.cordova.getActivity().runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if("_self".equals(var17)) {
                        ...
                        boolean var6 = var16.startsWith("javascript:");
                        Boolean var7 = null;
                        if(var6) {
                            var7 = Boolean.valueOf(true);
                        }

                        if(var7 == null) {
                            try {
                                Method var23 = Config.class.getMethod("isUrlWhiteListed", new Class[] {String.class});
                                Object[] var24 = new Object[] {var16};
                                var7 = (Boolean)var23.invoke((Object)null, var24);
                        ...
                        if(var7 == null) {
                            try {
                                PluginManager var17x = (PluginManager)InAppBrowser.this.webView.getClass().getMethod("getPluginManager", new Class[0]).invoke(InAppBrowser.this.webView, new Object[0]);
                                Method var18 = var17x.getClass().getMethod("shouldAllowNavigation", new Class[] {String.class});
                                Object[] var19x = new Object[] {var16};
                                var7 = (Boolean)var18.invoke(var17x, var19x);
                        ...
                        } else if(var16.startsWith("tel:")) {
                            try {
                                Log.d("InAppBrowser", "loading in dialer");
                                Intent var11 = new Intent("android.intent.action.DIAL");
                                var11.setData(Uri.parse(var16));
                                InAppBrowser.this.cordova.getActivity().startActivity(var11);
                            } catch (ActivityNotFoundException var25) {
                                LOG.method_4282("InAppBrowser", "Error dialing " + var16 + ": " + var25.toString());
                            }
                        } else {
                    ...
                    PluginResult var3x = new PluginResult(PluginResult.Status.field_2155, var1);
            ...
            PluginResult var6 = new PluginResult(PluginResult.Status.field_2155);
