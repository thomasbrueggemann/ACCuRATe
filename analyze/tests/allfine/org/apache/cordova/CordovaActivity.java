...
public class CordovaActivity extends Activity implements CordovaInterface {
    ...
    protected void createViews() {
        LOG.method_4279(TAG, "CordovaActivity.createViews()");
        ...
        ViewParent var2 = this.appView.getParent();
        if(var2 != null && var2 != this.root) {
            LOG.method_4279(TAG, "removing appView from existing parent");
            ((ViewGroup)var2).removeView(this.appView);
        }

        this.root.addView(this.appView);
        this.setContentView(this.root);
        int var3 = this.preferences.getInteger("BackgroundColor", -16777216);
        this.root.setBackgroundColor(var3);
    }
    ...
    public Context getContext() {
        LOG.method_4279(TAG, "This will be deprecated December 2012");
        return this;
    }
    ...
    public void init(CordovaWebView var1, CordovaWebViewClient var2, CordovaChromeClient var3) {
        LOG.method_4279(TAG, "CordovaActivity.init()");
        if(var1 == null) {
    ...
    protected void onActivityResult(int var1, int var2, Intent var3) {
        LOG.method_4279(TAG, "Incoming Result");
        ...
        if(var5 != null) {
            LOG.method_4279(TAG, "We have a callback to send this result to");
            var5.onActivityResult(var1, var2, var3);
        }
    }

    public void onCreate(Bundle var1) {
        LOG.method_4285(TAG, "Apache Cordova native platform version 3.6.4 is starting");
        LOG.method_4279(TAG, "CordovaActivity.onCreate()");
        this.loadConfig();
    ...
    public void onDestroy() {
        LOG.method_4279(TAG, "CordovaActivity.onDestroy()");
        super.onDestroy();
    ...
    public Object onMessage(String var1, Object var2) {
        if(!"onScrollChanged".equals(var1)) {
            LOG.method_4279(TAG, "onMessage(" + var1 + "," + var2 + ")");
        }
    ...
    protected void onPause() {
        super.onPause();
        LOG.method_4279(TAG, "Paused the application!");
    ...
    protected void onResume() {
        super.onResume();
        LOG.method_4279(TAG, "Resuming the App");
    ...
    protected void showSplashScreen(final int var1) {
        this.runOnUiThread(new Runnable() {
            public void run() {
                ...
                ImageView var3 = new ImageView(CordovaActivity.this.getActivity());
                var3.setLayoutParams(new android.view.ViewGroup.LayoutParams(-1, -1));
                var3.setScaleType(ScaleType.CENTER_CROP);
                var3.setImageResource(CordovaActivity.this.splashscreen);
                var2.addView(var3);
