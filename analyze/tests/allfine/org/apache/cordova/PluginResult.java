...
public class PluginResult {
    ...
    public String toCallbackString(String var1) {
        return this.status == PluginResult.Status.NO_RESULT.ordinal() && this.keepCallback?null:(this.status != PluginResult.Status.field_2155.ordinal() && this.status != PluginResult.Status.NO_RESULT.ordinal()?this.toErrorCallbackString(var1):this.toSuccessCallbackString(var1));
    }
    ...
    public static enum Status {
        ...
        static {
            PluginResult.Status[] var0 = new PluginResult.Status[]{NO_RESULT, field_2155, CLASS_NOT_FOUND_EXCEPTION, ILLEGAL_ACCESS_EXCEPTION, INSTANTIATION_EXCEPTION, MALFORMED_URL_EXCEPTION, IO_EXCEPTION, INVALID_ACTION, JSON_EXCEPTION, ERROR};
        }
    }
}
