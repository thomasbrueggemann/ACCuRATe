...
public class CordovaWebViewClient extends WebViewClient {
    ...
    public void onPageFinished(WebView var1, String var2) {
        ...
        if(this.isCurrentlyLoading) {
            ...
            LOG.method_4279("CordovaWebViewClient", "onPageFinished(" + var2 + ")");
    ...
    public void onPageStarted(WebView var1, String var2, Bitmap var3) {
        ...
        LOG.method_4279("CordovaWebViewClient", "onPageStarted(" + var2 + ")");
    ...
    public void onReceivedError(WebView var1, int var2, String var3, String var4) {
        if(this.isCurrentlyLoading) {
            ...
            LOG.method_4281("CordovaWebViewClient", "CordovaWebViewClient.onReceivedError: Error code=%s Description=%s URL=%s", var5);
