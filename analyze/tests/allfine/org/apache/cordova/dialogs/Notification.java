...
public class Notification extends CordovaPlugin {
    ...
    @SuppressLint({"NewApi"})
    private void changeTextDirection(Builder var1) {
        int var2 = VERSION.SDK_INT;
        var1.create();
        AlertDialog var4 = var1.show();
        if(var2 >= 17) {
            ((TextView)var4.findViewById(16908299)).setTextDirection(5);
        }

    }

    @SuppressLint({"NewApi"})
    private Builder createDialog(CordovaInterface var1) {
        return VERSION.SDK_INT >= 11?new Builder(var1.getActivity(), 5):new Builder(var1.getActivity());
    }

    @SuppressLint({"InlinedApi"})
    private ProgressDialog createProgressDialog(CordovaInterface var1) {
        return VERSION.SDK_INT >= 14?new ProgressDialog(var1.getActivity(), 5):new ProgressDialog(var1.getActivity());
    }
    ...
    public void activityStart(final String var1, final String var2) {
        ...
        try {
            ...
            Runnable var4 = new Runnable() {
                ...
                public void run() {
                    Notification.this.spinnerDialog = Notification.this.createProgressDialog(this.val$cordova);
                    Notification.this.spinnerDialog.setTitle(var1);
                    Notification.this.spinnerDialog.setMessage(var2);
                    Notification.this.spinnerDialog.setCancelable(true);
                    Notification.this.spinnerDialog.setIndeterminate(true);
                    Notification.this.spinnerDialog.setOnCancelListener(new OnCancelListener() {
    ...
    public void alert(final String var1, final String var2, final String var3, final CallbackContext var4) {
        ...
        try {
            Runnable var5 = new Runnable() {
                ...
                public void run() {
                    Builder var1x = Notification.this.createDialog(this.val$cordova);
                    ...
                    var1x.setPositiveButton(var3, new OnClickListener() {
                        public void onClick(DialogInterface var1x, int var2x) {
                            var1x.dismiss();
                            var4.sendPluginResult(new PluginResult(PluginResult.Status.field_2155, 0));
                        }
                    });
                    ...
                    Notification.this.changeTextDirection(var1x);
                }
            };
                    ...
                    if(var3.length() > 0) {
                        try {
                            var1x.setNegativeButton(var3.getString(0), new OnClickListener() {
                                public void onClick(DialogInterface var1x, int var2x) {
                                    var1x.dismiss();
                                    var4.sendPluginResult(new PluginResult(PluginResult.Status.field_2155, 1));
                                }
                            });
                    ...
                    if(var3.length() > 1) {
                        try {
                            var1x.setNeutralButton(var3.getString(1), new OnClickListener() {
                                public void onClick(DialogInterface var1x, int var2x) {
                                    var1x.dismiss();
                                    var4.sendPluginResult(new PluginResult(PluginResult.Status.field_2155, 2));
                                }
                            });
                    ...
                    if(var3.length() > 2) {
                        try {
                            var1x.setPositiveButton(var3.getString(2), new OnClickListener() {
                                public void onClick(DialogInterface var1x, int var2x) {
                                    var1x.dismiss();
                                    var4.sendPluginResult(new PluginResult(PluginResult.Status.field_2155, 3));
                                }
                            });
    ...
    public void progressStart(final String var1, final String var2) {
        ...
        try {
            ...
            Runnable var4 = new Runnable() {
                ...
                public void run() {
                    Notification.this.progressDialog = Notification.this.createProgressDialog(this.val$cordova);
        ...
        try {
            Runnable var6 = new Runnable() {
                ...
                public void run() {
                    ...
                    var1x.setHint(var4);
                    Builder var2x = Notification.this.createDialog(this.val$cordova);
                    ...
                    Notification.this.changeTextDirection(var2x);
                }
            };
