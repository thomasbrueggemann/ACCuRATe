    ...
    public WebResourceResponse shouldInterceptRequest(WebView var1, String var2) {
        try {
            if(this.isUrlHarmful(var2)) {
                LOG.method_4291("IceCreamCordovaWebViewClient", "URL blocked by whitelist: " + var2);
            ...
            if(!(var9 instanceof FileNotFoundException)) {
                LOG.method_4283("IceCreamCordovaWebViewClient", "Error occurred while loading a file (returning a 404).", var9);
            }
