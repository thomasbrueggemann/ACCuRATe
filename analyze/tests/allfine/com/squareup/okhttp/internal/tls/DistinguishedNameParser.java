...
final class DistinguishedNameParser {
    ...
    private final String field_1647;
    private int end;
    private final int length;
    private int pos;

    public DistinguishedNameParser(X500Principal var1) {
        this.field_1647 = var1.getName("RFC2253");
        this.length = this.field_1647.length();
    }
    ...
    private int getByte(int var1) {
        if(var1 + 1 >= this.length) {
            throw new IllegalStateException("Malformed DN: " + this.field_1647);
        } else {
    ...
    private char getEscaped() {
        ...
        if(this.pos == this.length) {
            throw new IllegalStateException("Unexpected end of DN: " + this.field_1647);
        } else {
            switch(this.chars[this.pos]) {
                case ' ':
                case '\"':
    ...
    public String findMostSpecific(String var1) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.field_1647.toCharArray();
