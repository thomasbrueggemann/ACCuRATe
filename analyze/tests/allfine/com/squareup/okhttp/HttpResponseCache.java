...
public final class HttpResponseCache extends ResponseCache {
    ...
    static class EntryCacheResponse extends CacheResponse {
        ...
        private final InputStream field_5083;
        private final DiskLruCache.Snapshot snapshot;

        public EntryCacheResponse(HttpResponseCache.Entry var1, DiskLruCache.Snapshot var2) {
            this.entry = var1;
            this.snapshot = var2;
            this.field_5083 = HttpResponseCache.newBodyInputStream(var2);
        }
    ...
    static class EntrySecureCacheResponse extends SecureCacheResponse {
        private final HttpResponseCache.Entry entry;
        // $FF: renamed from: in java.io.InputStream
        private final InputStream field_4492;
        private final DiskLruCache.Snapshot snapshot;

        public EntrySecureCacheResponse(HttpResponseCache.Entry var1, DiskLruCache.Snapshot var2) {
            this.entry = var1;
            this.snapshot = var2;
            this.field_4492 = HttpResponseCache.newBodyInputStream(var2);
        }
