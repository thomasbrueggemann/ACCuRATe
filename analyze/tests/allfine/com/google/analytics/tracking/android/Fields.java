...
public final class Fields {
    ...
    public static String contentGroup(int var0) {
        return getParam("&cg", var0);
    }

    public static String customDimension(int var0) {
        return getParam("&cd", var0);
    }

    public static String customMetric(int var0) {
        return getParam("&cm", var0);
    }

    private static String getParam(String var0, int var1) {
        if(var1 < 1) {
            Log.method_2104("index out of range for " + var0 + " (" + var1 + ")");
            return "";
        } else {
            return var0 + var1;
        }
