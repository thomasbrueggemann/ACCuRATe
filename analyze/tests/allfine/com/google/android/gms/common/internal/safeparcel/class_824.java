...
public class class_824 {
    ...
    public static String[] method_4328(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
    ...
    public static int method_4329(Parcel var0) {
        return var0.readInt();
    }

    // $FF: renamed from: B (android.os.Parcel, int) java.util.ArrayList
    public static ArrayList<Integer> method_4330(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static int method_4331(Parcel var0) {
        int var1 = method_4329(var0);
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(method_4340(var1) != 20293) {
            throw new class_824.class_1307("Expected object header. Got 0x" + Integer.toHexString(var1), var0);
        } else {
            int var4 = var3 + var2;
            if(var4 >= var3 && var4 <= var0.dataSize()) {
                return var4;
            } else {
                throw new class_824.class_1307("Size read is invalid start=" + var3 + " end=" + var4, var0);
            }
        }
    }

    // $FF: renamed from: C (android.os.Parcel, int) java.util.ArrayList
    public static ArrayList<String> method_4332(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static Parcel method_4333(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static Parcel[] method_4334(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static int method_4335(Parcel var0, int var1) {
    ...
    public static <T extends Parcelable> T method_4336(Parcel var0, int var1, Creator<T> var2) {
        int var3 = method_4335(var0, var1);
    ...
    private static void method_4337(Parcel var0, int var1, int var2) {
        int var3 = method_4335(var0, var1);
        if(var3 != var2) {
            throw new class_824.class_1307("Expected size " + var2 + " got " + var3 + " (0x" + Integer.toHexString(var3) + ")", var0);
        }
    }

    // $FF: renamed from: a (android.os.Parcel, int, int, int) void
    private static void method_4338(Parcel var0, int var1, int var2, int var3) {
        if(var2 != var3) {
            throw new class_824.class_1307("Expected size " + var3 + " got " + var2 + " (0x" + Integer.toHexString(var2) + ")", var0);
        }
    }

    // $FF: renamed from: a (android.os.Parcel, int, java.util.List, java.lang.ClassLoader) void
    public static void method_4339(Parcel var0, int var1, List var2, ClassLoader var3) {
        int var4 = method_4335(var0, var1);
    ...
    public static int method_4340(int var0) {
        return '\uffff' & var0;
    }

    // $FF: renamed from: b (android.os.Parcel, int) void
    public static void method_4341(Parcel var0, int var1) {
        var0.setDataPosition(method_4335(var0, var1) + var0.dataPosition());
    }

    // $FF: renamed from: b (android.os.Parcel, int, android.os.Parcelable.Creator) java.lang.Object[]
    public static <T> T[] method_4342(Parcel var0, int var1, Creator<T> var2) {
        int var3 = method_4335(var0, var1);
        int var4 = var0.dataPosition();
        if(var3 == 0) {
            return null;
    ...
    public static <T> ArrayList<T> method_4343(Parcel var0, int var1, Creator<T> var2) {
        int var3 = method_4335(var0, var1);
        int var4 = var0.dataPosition();
        if(var3 == 0) {
            return null;
    ...
    public static boolean method_4344(Parcel var0, int var1) {
        method_4337(var0, var1, 4);
        return var0.readInt() != 0;
    }

    // $FF: renamed from: d (android.os.Parcel, int) java.lang.Boolean
    public static Boolean method_4345(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        if(var2 == 0) {
            return null;
        } else {
            method_4338(var0, var1, var2, 4);
            boolean var3;
            if(var0.readInt() != 0) {
                var3 = true;
            } else {
    ...
    public static byte method_4346(Parcel var0, int var1) {
        method_4337(var0, var1, 4);
        return (byte)var0.readInt();
    }

    // $FF: renamed from: f (android.os.Parcel, int) short
    public static short method_4347(Parcel var0, int var1) {
        method_4337(var0, var1, 4);
        return (short)var0.readInt();
    }

    // $FF: renamed from: g (android.os.Parcel, int) int
    public static int method_4348(Parcel var0, int var1) {
        method_4337(var0, var1, 4);
        return var0.readInt();
    }

    // $FF: renamed from: h (android.os.Parcel, int) java.lang.Integer
    public static Integer method_4349(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        if(var2 == 0) {
            return null;
        } else {
    ...
    public static long method_4350(Parcel var0, int var1) {
        method_4337(var0, var1, 8);
        return var0.readLong();
    }

    // $FF: renamed from: j (android.os.Parcel, int) java.lang.Long
    public static Long method_4351(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        if(var2 == 0) {
            return null;
        } else {
            method_4338(var0, var1, var2, 8);
            return Long.valueOf(var0.readLong());
        }
    }

    // $FF: renamed from: k (android.os.Parcel, int) java.math.BigInteger
    public static BigInteger method_4352(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static float method_4353(Parcel var0, int var1) {
        method_4337(var0, var1, 4);
        return var0.readFloat();
    }

    // $FF: renamed from: m (android.os.Parcel, int) double
    public static double method_4354(Parcel var0, int var1) {
        method_4337(var0, var1, 8);
        return var0.readDouble();
    }

    // $FF: renamed from: n (android.os.Parcel, int) java.math.BigDecimal
    public static BigDecimal method_4355(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static String method_4356(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static IBinder method_4357(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static Bundle method_4358(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static byte[] method_4359(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static byte[][] method_4360(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return (byte[][])null;
    ...
    public static boolean[] method_4361(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static int[] method_4362(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static long[] method_4363(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static BigInteger[] method_4364(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static float[] method_4365(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static double[] method_4366(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static BigDecimal[] method_4367(Parcel var0, int var1) {
        int var2 = method_4335(var0, var1);
        int var3 = var0.dataPosition();
        if(var2 == 0) {
            return null;
    ...
    public static class class_1307 extends RuntimeException {
        public class_1307(String var1, Parcel var2) {
