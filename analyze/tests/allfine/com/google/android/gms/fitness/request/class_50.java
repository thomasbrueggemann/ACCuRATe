...
public interface class_50 extends IInterface {
    ...
    public abstract static class class_1193 extends Binder implements class_50 {
        public class_1193() {
            this.attachInterface(this, "com.google.android.gms.fitness.request.IBleScanCallback");
        }

        // $FF: renamed from: ay (android.os.IBinder) com.google.android.gms.fitness.request.l
        public static class_50 method_2343(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.fitness.request.IBleScanCallback");
                return (class_50)(var1 != null && var1 instanceof class_50?(class_50)var1:new class_50.class_1194(var0));
            }
        }
    ...
    private static class class_1194 implements class_50 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_3418;

        class_1194(IBinder var1) {
            this.field_3418 = var1;
        }
        ...
        public void onScanStopped() throws RemoteException {
            ...
            try {
                ...
                this.field_3418.transact(2, var1, (Parcel)null, 1);
            } finally {
                var1.recycle();
            }
