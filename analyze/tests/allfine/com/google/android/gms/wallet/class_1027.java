...
public class class_1027 implements Creator<CountrySpecification> {
    // $FF: renamed from: a (com.google.android.gms.wallet.CountrySpecification, android.os.Parcel, int) void
    static void method_5354(CountrySpecification var0, Parcel var1, int var2) {
        int var3 = class_823.method_4298(var1);
        class_823.method_4325(var1, 1, var0.getVersionCode());
        class_823.method_4313(var1, 2, var0.field_5316, false);
        class_823.method_4301(var1, var3);
    }

    // $FF: synthetic method
    public Object createFromParcel(Parcel var1) {
        return this.method_5355(var1);
    }

    // $FF: renamed from: dp (android.os.Parcel) com.google.android.gms.wallet.CountrySpecification
    public CountrySpecification method_5355(Parcel var1) {
    ...
    // $FF: renamed from: fq (int) com.google.android.gms.wallet.CountrySpecification[]
    public CountrySpecification[] method_5356(int var1) {
        return new CountrySpecification[var1];
    }

    // $FF: synthetic method
    public Object[] newArray(int var1) {
        return this.method_5356(var1);
    }
}
