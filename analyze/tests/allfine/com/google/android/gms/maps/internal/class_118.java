...
public interface class_118 extends IInterface {
    ...
    void method_641(class_206 var1) throws RemoteException;

    void onSnapshotReady(Bitmap var1) throws RemoteException;

    public abstract static class class_1593 extends Binder implements class_118 {
        public class_1593() {
            this.attachInterface(this, "com.google.android.gms.maps.internal.ISnapshotReadyCallback");
        }

        // $FF: renamed from: bk (android.os.IBinder) com.google.android.gms.maps.internal.s
        public static class_118 method_4403(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
                return (class_118)(var1 != null && var1 instanceof class_118?(class_118)var1:new class_118.class_1594(var0));
            }
        }
        ...
        public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
            switch(var1) {
                ...
                case 2:
                    var2.enforceInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
                    this.h(class_206.class_1795.method_5435(var2.readStrongBinder()));
                    var3.writeNoException();
                    return true;
                case 1598968902:
    ...
    private static class class_1594 implements class_118 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_4493;

        class_1594(IBinder var1) {
            this.field_4493 = var1;
        }

        public IBinder asBinder() {
            return this.field_4493;
        }

        // $FF: renamed from: h (com.google.android.gms.dynamic.d) void
        public void method_641(class_206 param1) throws RemoteException {
