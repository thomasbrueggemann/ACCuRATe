...
public class MapFragment extends Fragment {
    private final MapFragment.class_1374 aiQ = new MapFragment.class_1374(this);
    ...
    public final GoogleMap getMap() {
        IMapFragmentDelegate var1 = this.method_5789();
        if(var1 != null) {
    ...
    protected IMapFragmentDelegate method_5789() {
        this.aiQ.method_2713();
        return this.aiQ.it() == null?null:((MapFragment.class_1373)this.aiQ.it()).method_3367();
    }
    ...
    public void onAttach(Activity var1) {
        super.onAttach(var1);
        this.aiQ.setActivity(var1);
    }

    public void onCreate(Bundle var1) {
        super.onCreate(var1);
        this.aiQ.onCreate(var1);
    }

    public View onCreateView(LayoutInflater var1, ViewGroup var2, Bundle var3) {
        return this.aiQ.onCreateView(var1, var2, var3);
    }
    ...
    public void onInflate(Activity var1, AttributeSet var2, Bundle var3) {
        ...
        this.aiQ.onInflate(var1, var5, var3);
    }
    ...
    public void onSaveInstanceState(Bundle var1) {
        ...
        this.aiQ.onSaveInstanceState(var1);
    }
    ...
    static class class_1373 implements LifecycleDelegate {
        // $FF: renamed from: Sj android.app.Fragment
        private final Fragment field_2948;
        private final IMapFragmentDelegate aiS;

        public class_1373(Fragment var1, IMapFragmentDelegate var2) {
            this.aiS = (IMapFragmentDelegate)class_1090.method_5685(var2);
            this.field_2948 = (Fragment)class_1090.method_5685(var1);
        }

        // $FF: renamed from: mz () com.google.android.gms.maps.internal.IMapFragmentDelegate
        public IMapFragmentDelegate method_3367() {
            return this.aiS;
        }
    ...
    static class class_1374 extends a<MapFragment.class_1373> {
        // $FF: renamed from: Sj android.app.Fragment
        private final Fragment field_1582;
        protected f<MapFragment.class_1373> aiT;
        // $FF: renamed from: nr android.app.Activity
        private Activity field_1583;

        class_1374(Fragment var1) {
        ...
        protected void method_2706(f<MapFragment.class_1373> var1) {
            this.aiT = var1;
            this.method_2713();
        }
        ...
        public void method_2713() {
            if(this.field_1583 != null && this.aiT != null && this.it() == null) {
                try {
                    MapsInitializer.initialize(this.field_1583);
                    IMapFragmentDelegate var4 = class_814.method_4233(this.field_1583).method_651(class_1046.method_5437(this.field_1583));
                    this.aiT.method_1058(new MapFragment.class_1373(this.field_1582, var4));
