...
public interface class_128 extends IInterface {
    ...
    public abstract static class class_1603 extends Binder implements class_128 {
        public class_1603() {
            this.attachInterface(this, "com.google.android.gms.maps.internal.ICancelableCallback");
        }

        // $FF: renamed from: aO (android.os.IBinder) com.google.android.gms.maps.internal.b
        public static class_128 method_4196(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
                return (class_128)(var1 != null && var1 instanceof class_128?(class_128)var1:new class_128.class_1604(var0));
            }
        }
    ...
    private static class class_1604 implements class_128 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_4856;

        class_1604(IBinder var1) {
            this.field_4856 = var1;
        }

        public IBinder asBinder() {
            return this.field_4856;
        }
        ...
        public void onCancel() throws RemoteException {
            ...
            try {
                ...
                this.field_4856.transact(2, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onFinish() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.ICancelableCallback");
                this.field_4856.transact(1, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
