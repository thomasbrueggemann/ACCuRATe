...
public interface class_59 extends IInterface {
    ...
    boolean method_307(class_59 var1) throws RemoteException;
    ...
    public abstract static class class_1681 extends Binder implements class_59 {
        // $FF: renamed from: bs (android.os.IBinder) com.google.android.gms.maps.model.internal.d
        public static class_59 method_5079(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                return (class_59)(var1 != null && var1 instanceof class_59?(class_59)var1:new class_59.class_1682(var0));
            }
        }
        ...
        public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
            switch(var1) {
                ...
                case 5:
                    var2.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    boolean var6 = this.b(method_5079(var2.readStrongBinder()));
                    var3.writeNoException();
                    byte var7 = 0;
                    if(var6) {
                        var7 = 1;
    ...
    private static class class_1682 implements class_59 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_4033;

        class_1682(IBinder var1) {
        ...
        // $FF: renamed from: b (com.google.android.gms.maps.model.internal.d) boolean
        public boolean method_307(class_59 param1) throws RemoteException {
        ...
        public int getActiveLevelIndex() throws RemoteException {
            ...
            try {
                ...
                this.field_4033.transact(1, var1, var2, 0);
                var2.readException();
                var5 = var2.readInt();
            } finally {
                var2.recycle();
        ...
        public int getDefaultLevelIndex() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                this.field_4033.transact(2, var1, var2, 0);
                var2.readException();
                var5 = var2.readInt();
            } finally {
                var2.recycle();
        ...
        public List<IBinder> getLevels() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                this.field_4033.transact(3, var1, var2, 0);
                var2.readException();
        ...
        public int hashCodeRemote() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                this.field_4033.transact(6, var1, var2, 0);
                var2.readException();
                var5 = var2.readInt();
            } finally {
                var2.recycle();
        ...
        public boolean isUnderground() throws RemoteException {
            ...
            try {
                var8 = true;
                var1.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                this.field_4033.transact(4, var1, var2, 0);
                var2.readException();
                var5 = var2.readInt();
                var8 = false;
            } finally {
