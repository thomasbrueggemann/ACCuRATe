...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    void onInflate(class_206 var1, StreetViewPanoramaOptions var2, Bundle var3) throws RemoteException;
    ...
    public abstract static class class_1584 extends Binder implements IStreetViewPanoramaFragmentDelegate {
        // $FF: renamed from: bm (android.os.IBinder) com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate
        public static IStreetViewPanoramaFragmentDelegate method_5939(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                return (IStreetViewPanoramaFragmentDelegate)(var1 != null && var1 instanceof IStreetViewPanoramaFragmentDelegate?(IStreetViewPanoramaFragmentDelegate)var1:new IStreetViewPanoramaFragmentDelegate.class_1585(var0));
            }
        }
        ...
        public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
            switch(var1) {
                ...
                case 2:
                    ...
                    if(var2.readInt() != 0) {
                        var15 = StreetViewPanoramaOptions.CREATOR.method_5540(var2);
                    } else {
                        var15 = null;
                    }
                ...
                case 4:
                    var2.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    class_206 var8 = class_206.class_1795.method_5435(var2.readStrongBinder());
                    class_206 var9 = class_206.class_1795.method_5435(var2.readStrongBinder());
                    Bundle var10;
                    if(var2.readInt() != 0) {
                    ...
                    class_206 var11 = this.onCreateView(var8, var9, var10);
                    var3.writeNoException();
                    IBinder var12 = null;
                    if(var11 != null) {
    ...
    private static class class_1585 implements IStreetViewPanoramaFragmentDelegate {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_4193;

        class_1585(IBinder var1) {
        ...
        public IStreetViewPanoramaDelegate getStreetViewPanorama() throws RemoteException {
            ...
            try {
                ...
                this.field_4193.transact(1, var1, var2, 0);
                var2.readException();
        ...
        public boolean isReady() throws RemoteException {
            ...
            try {
                var8 = true;
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                this.field_4193.transact(11, var1, var2, 0);
                var2.readException();
                var5 = var2.readInt();
                var8 = false;
            } finally {
        ...
        public void onDestroy() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                this.field_4193.transact(8, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onDestroyView() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                this.field_4193.transact(7, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onInflate(class_206 param1, StreetViewPanoramaOptions param2, Bundle param3) throws RemoteException {
            // $FF: Couldn't be decompiled
        }
        ...
        public void onLowMemory() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                this.field_4193.transact(9, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onPause() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                this.field_4193.transact(6, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onResume() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                this.field_4193.transact(5, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
