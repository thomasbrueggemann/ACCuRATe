...
public interface IMapViewDelegate extends IInterface {
    ...
    public abstract static class class_1560 extends Binder implements IMapViewDelegate {
        // $FF: renamed from: aU (android.os.IBinder) com.google.android.gms.maps.internal.IMapViewDelegate
        public static IMapViewDelegate method_3891(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IMapViewDelegate");
                return (IMapViewDelegate)(var1 != null && var1 instanceof IMapViewDelegate?(IMapViewDelegate)var1:new IMapViewDelegate.class_1561(var0));
            }
        }
    ...
    private static class class_1561 implements IMapViewDelegate {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_4567;

        class_1561(IBinder var1) {
            this.field_4567 = var1;
        }
        ...
        public IGoogleMapDelegate getMap() throws RemoteException {
            ...
            try {
                ...
                this.field_4567.transact(1, var1, var2, 0);
                var2.readException();
        ...
        public class_206 getView() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                this.field_4567.transact(8, var1, var2, 0);
                var2.readException();
        ...
        public void onDestroy() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                this.field_4567.transact(5, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onLowMemory() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                this.field_4567.transact(6, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onPause() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                this.field_4567.transact(4, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onResume() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                this.field_4567.transact(3, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
