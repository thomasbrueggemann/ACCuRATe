...
public interface IMapFragmentDelegate extends IInterface {
    ...
    void onInflate(class_206 var1, GoogleMapOptions var2, Bundle var3) throws RemoteException;
    ...
    public abstract static class class_1759 extends Binder implements IMapFragmentDelegate {
        // $FF: renamed from: aT (android.os.IBinder) com.google.android.gms.maps.internal.IMapFragmentDelegate
        public static IMapFragmentDelegate method_4994(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                return (IMapFragmentDelegate)(var1 != null && var1 instanceof IMapFragmentDelegate?(IMapFragmentDelegate)var1:new IMapFragmentDelegate.class_1760(var0));
            }
        }
        ...
        public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
            switch(var1) {
                ...
                case 2:
                    ...
                    if(var2.readInt() != 0) {
                        var15 = GoogleMapOptions.CREATOR.method_5543(var2);
                    } else {
                        var15 = null;
                    }
    ...
    private static class class_1760 implements IMapFragmentDelegate {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_4651;

        class_1760(IBinder var1) {
            this.field_4651 = var1;
        }

        public IBinder asBinder() {
            return this.field_4651;
        }
        ...
        public IGoogleMapDelegate getMap() throws RemoteException {
            ...
            try {
                ...
                this.field_4651.transact(1, var1, var2, 0);
                var2.readException();
                var5 = IGoogleMapDelegate.class_1308.method_3121(var2.readStrongBinder());
            } finally {
                var2.recycle();
                var1.recycle();
            }
        ...
        public boolean isReady() throws RemoteException {
            ...
            try {
                var8 = true;
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                this.field_4651.transact(11, var1, var2, 0);
                var2.readException();
                var5 = var2.readInt();
                var8 = false;
            } finally {
        ...
        public void onDestroy() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                this.field_4651.transact(8, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onDestroyView() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                this.field_4651.transact(7, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onInflate(class_206 param1, GoogleMapOptions param2, Bundle param3) throws RemoteException {
            // $FF: Couldn't be decompiled
        }
        ...
        public void onLowMemory() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                this.field_4651.transact(9, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onPause() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                this.field_4651.transact(6, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public void onResume() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                this.field_4651.transact(5, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
