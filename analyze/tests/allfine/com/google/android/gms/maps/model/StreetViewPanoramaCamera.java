...
import com.google.android.gms.maps.model.class_986;

public class StreetViewPanoramaCamera implements SafeParcelable {
    public static final class_986 CREATOR = new class_986();
    // $FF: renamed from: BR int
    private final int field_5304;
    ...
    StreetViewPanoramaCamera(int var1, float var2, float var3, float var4) {
        ...
        class_1090.method_5683(var5, "Tilt needs to be between -90 and 90 inclusive");
        this.field_5304 = var1;
        this.zoom = var2;
        this.tilt = 0.0F + var3;
        float var6;
        if((double)var4 <= 0.0D) {
        ...
        this.akp = (new StreetViewPanoramaOrientation.Builder()).tilt(var3).bearing(var4).build();
    }
    ...
    public String toString() {
        return class_1089.method_5673(this).method_5425("zoom", Float.valueOf(this.zoom)).method_5425("tilt", Float.valueOf(this.tilt)).method_5425("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel var1, int var2) {
        class_986.method_5178(this, var1, var2);
    }
