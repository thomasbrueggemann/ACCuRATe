...
public interface class_116 extends IInterface {
    ...
    public abstract static class class_1360 extends Binder implements class_116 {
        public class_1360() {
            this.attachInterface(this, "com.google.android.gms.maps.internal.IOnStreetViewPanoramaChangeListener");
        }

        // $FF: renamed from: bh (android.os.IBinder) com.google.android.gms.maps.internal.q
        public static class_116 method_1626(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.maps.internal.IOnStreetViewPanoramaChangeListener");
                return (class_116)(var1 != null && var1 instanceof class_116?(class_116)var1:new class_116.class_1361(var0));
            }
        }
        ...
        public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
            switch(var1) {
                case 1:
                    ...
                    if(var2.readInt() != 0) {
                        var5 = StreetViewPanoramaLocation.CREATOR.method_5175(var2);
                    } else {
                        var5 = null;
                    }
    ...
    private static class class_1361 implements class_116 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_3051;

        class_1361(IBinder var1) {
            this.field_3051 = var1;
        }

        public IBinder asBinder() {
            return this.field_3051;
        }
