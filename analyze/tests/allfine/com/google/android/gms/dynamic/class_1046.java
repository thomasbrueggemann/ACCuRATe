...
public final class class_1046<T> extends class_206.class_1795 {
    // $FF: renamed from: Sk java.lang.Object
    private final T field_4777;

    private class_1046(T var1) {
        this.field_4777 = var1;
    }

    // $FF: renamed from: f (com.google.android.gms.dynamic.d) java.lang.Object
    public static <T> T method_5436(d var0) {
        if(var0 instanceof class_1046) {
            return ((class_1046)var0).field_4777;
        } else {
    ...
    public static <T> d method_5437(T var0) {
        return new class_1046(var0);
    }
}
