...
public final class GameRequestSummaryBuffer extends DataBuffer<GameRequestSummary> {
    // $FF: renamed from: dW (int) com.google.android.gms.games.request.GameRequestSummary
    public GameRequestSummary method_2898(int var1) {
        return new GameRequestSummaryRef(this.II, var1);
    }

    // $FF: synthetic method
    public Object get(int var1) {
        return this.method_2898(var1);
    }
}
