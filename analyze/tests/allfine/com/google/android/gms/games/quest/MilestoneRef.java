...
public final class MilestoneRef extends class_255 implements Milestone {
    MilestoneRef(DataHolder var1, int var2) {
        super(var1, var2);
    }

    // $FF: renamed from: lI () long
    private long method_1679() {
    ...
    public boolean equals(Object var1) {
        return MilestoneEntity.method_4904(this, var1);
    }
    ...
    public long getCurrentProgress() {
        switch(this.getState()) {
            ...
            default:
                return 0L;
            case 2:
                return this.getLong("current_value") - this.method_1679();
            case 3:
            case 4:
    ...
    public int hashCode() {
        return MilestoneEntity.method_4903(this);
    }

    public String toString() {
        return MilestoneEntity.method_4905(this);
    }
