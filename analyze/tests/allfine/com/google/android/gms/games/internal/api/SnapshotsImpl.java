...
public final class SnapshotsImpl implements Snapshots {
    public PendingResult<Snapshots.CommitSnapshotResult> commitAndClose(GoogleApiClient var1, final Snapshot var2, final SnapshotMetadataChange var3) {
        return var1.method_899(new SnapshotsImpl.CommitImpl(null) {
    ...
    public PendingResult<Snapshots.LoadSnapshotsResult> load(GoogleApiClient var1, final boolean var2) {
        return var1.method_897(new SnapshotsImpl.LoadImpl(null) {
            // $FF: renamed from: a (com.google.android.gms.games.internal.GamesClientImpl) void
    ...
    public PendingResult<Snapshots.OpenSnapshotResult> open(GoogleApiClient var1, final String var2, final boolean var3) {
        return var1.method_899(new SnapshotsImpl.OpenImpl(null) {
            // $FF: renamed from: a (com.google.android.gms.games.internal.GamesClientImpl) void
            protected void method_1471(GamesClientImpl var1) {
    ...
    public PendingResult<Snapshots.OpenSnapshotResult> resolveConflict(GoogleApiClient var1, final String var2, final String var3, final SnapshotMetadataChange var4, Contents var5) {
        return var1.method_899(new SnapshotsImpl.OpenImpl(null) {
            // $FF: renamed from: ZT com.google.android.gms.games.snapshot.SnapshotContents
            // $FF: synthetic field
            final SnapshotContents field_503;
            ...
            // $FF: renamed from: a (com.google.android.gms.games.internal.GamesClientImpl) void
            protected void method_1470(GamesClientImpl var1) throws RemoteException {
                var1.method_1914(this, var2, var3, var4, this.field_503);
            }
        });
    }

    public PendingResult<Snapshots.OpenSnapshotResult> resolveConflict(GoogleApiClient var1, final String var2, final String var3, final SnapshotMetadataChange var4, final SnapshotContents var5) {
        return var1.method_899(new SnapshotsImpl.OpenImpl(null) {
            // $FF: renamed from: a (com.google.android.gms.games.internal.GamesClientImpl) void
            protected void method_1469(GamesClientImpl var1) throws RemoteException {
                var1.method_1914(this, var2, var3, var4, var5);
            }
        });
    }
    ...
    private abstract static class CommitImpl extends Games.BaseGamesApiMethodImpl<Snapshots.CommitSnapshotResult> {
        ...
        public Snapshots.CommitSnapshotResult method_1472(final Status var1) {
    ...
    private abstract static class DeleteImpl extends Games.BaseGamesApiMethodImpl<Snapshots.DeleteSnapshotResult> {
        ...
        public Snapshots.DeleteSnapshotResult method_1466(final Status var1) {
    ...
    private abstract static class LoadImpl extends Games.BaseGamesApiMethodImpl<Snapshots.LoadSnapshotsResult> {
        ...
        public Snapshots.LoadSnapshotsResult method_1474(final Status var1) {
            return new Snapshots.LoadSnapshotsResult() {
                public SnapshotMetadataBuffer getSnapshots() {
                    return new SnapshotMetadataBuffer(DataHolder.method_5982(14));
                }
    ...
    private abstract static class OpenImpl extends Games.BaseGamesApiMethodImpl<Snapshots.OpenSnapshotResult> {
        ...
        public Snapshots.OpenSnapshotResult method_1468(final Status var1) {
