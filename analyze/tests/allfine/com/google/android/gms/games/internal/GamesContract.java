...
public final class GamesContract {
    public interface AccountMetadataColumns {
        ...
        String[] field_24 = new String[] {"account_name", "external_player_id", "match_sync_token", "last_package_scan_timestamp", "quest_sync_token", "quest_sync_metadata_token", "request_sync_token", "xp_sync_token", "cover_photo_image_id", "cover_photo_image_uri", "cover_photo_image_url"};
    }

    public interface AchievementDefinitionsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_12 = new String[] {"game_id", "external_achievement_id", "type", "name", "description", "unlocked_icon_image_id", "unlocked_icon_image_uri", "unlocked_icon_image_url", "revealed_icon_image_id", "revealed_icon_image_uri", "revealed_icon_image_url", "total_steps", "formatted_total_steps", "initial_state", "sorting_rank", "definition_xp_value"};
    }
    ...
    public interface AchievementPendingOpsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_28 = new String[] {"client_context_id", "external_achievement_id", "achievement_type", "new_state", "steps_to_increment", "min_steps_to_set", "external_game_id", "external_player_id"};
    }

    public interface AclsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_19 = new String[] {"specified_by_user", "pacl"};
    }

    public interface ApplicationSessionColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_27 = new String[] {"client_context_id", "end_time", "external_game_id", "session_id", "start_time"};
    }

    public interface ClientContextsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_15 = new String[] {"package_name", "package_uid", "account_name"};
    }

    public interface ContactSettingsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_17 = new String[] {"mobile_notifications_enabled", "match_notifications_enabled", "quest_notifications_enabled", "request_notifications_enabled", "level_notifications_enabled"};
    }
    ...
    public interface EventInstancesColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_26 = new String[] {"definition_id", "player_id", "formatted_value", "last_updated_timestamp"};
    }

    public interface EventPendingOpsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_29 = new String[] {"client_context_id", "instance_id", "window_start_time", "window_end_time", "increment", "request_id"};
    }

    public interface ExperienceEventColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_13 = new String[] {"external_experience_id", "game_id", "created_timestamp", "current_xp", "xp_earned", "display_title", "display_description", "display_string", "type", "icon_id", "icon_url", "icon_uri", "newLevel"};
    }
    ...
    public interface InvitationsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_23 = new String[] {"game_id", "external_invitation_id", "external_inviter_id", "creation_timestamp", "last_modified_timestamp", "description", "type", "variant", "has_automatch_criteria", "automatch_min_players", "automatch_max_players", "inviter_in_circles"};
    }

    public interface LeaderboardInstancesColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_33 = new String[] {"leaderboard_id", "timespan", "collection", "player_raw_score", "player_display_score", "player_rank", "player_display_rank", "player_score_tag", "total_scores", "top_page_token_next", "window_page_token_prev", "window_page_token_next"};
    }
    ...
    public interface MilestoneColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_14 = new String[] {"completion_reward_data", "event_instance_id", "external_milestone_id", "initial_value", "quest_id", "milestones_sorting_rank", "milestone_state", "target_value"};
    }

    public interface NotificationsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_11 = new String[] {"notification_id", "game_id", "external_sub_id", "type", "image_id", "ticker", "title", "text", "coalesced_text", "timestamp", "acknowledged", "alert_level"};
    }
    ...
    public interface ParticipantsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_16 = new String[] {"match_id", "invitation_id", "external_participant_id", "player_id", "default_display_image_id", "default_display_image_url", "default_display_hi_res_image_id", "default_display_hi_res_image_url", "default_display_name", "player_status", "client_address", "result_type", "placing", "connected", "capabilities"};
    }

    public interface PlayerLevelColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_25 = new String[] {"level_value", "level_min_xp", "level_max_xp", "version"};
    }
    ...
    public interface ProfileSettingsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_21 = new String[] {"profile_visible", "profile_visibility_explicitly_set"};
    }

    public interface QuestsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_22 = new String[] {"accepted_ts", "quest_banner_image_id", "quest_banner_image_uri", "quest_banner_image_url", "quest_description", "quest_end_ts", "external_quest_id", "game_id", "quest_icon_image_id", "quest_icon_image_uri", "quest_icon_image_url", "quest_last_updated_ts", "quest_name", "notified", "notification_ts", "quest_start_ts", "quest_state", "quest_type"};
    }

    public interface RequestPendingOpsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_20 = new String[] {"client_context_id", "external_request_id", "external_game_id"};
    }
    ...
    public interface RequestsColumns {
        // $FF: renamed from: XV java.lang.String[]
        String[] field_18 = new String[] {"external_request_id", "game_id", "sender_id", "data", "type", "creation_timestamp", "expiration_timestamp", "status"};
    }
