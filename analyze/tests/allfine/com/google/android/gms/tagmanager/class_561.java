...
class class_561 extends class_560 {
    // $FF: renamed from: ID java.lang.String
    private static final String field_3072;
    private final Context mContext;

    static {
        field_3072 = class_530.field_2506.toString();
    }

    public class_561(Context var1) {
        super(field_3072, new String[0]);
        this.mContext = var1;
    }
    ...
    public class_53.class_1172 method_3411(Map<String, class_53.class_1172> var1) {
        String var2 = this.method_3416(this.mContext);
    ...
    protected String method_3416(Context var1) {
