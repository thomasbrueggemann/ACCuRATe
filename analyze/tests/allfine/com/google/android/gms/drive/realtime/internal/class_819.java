...
public class class_819 implements Creator<EndCompoundOperationRequest> {
    // $FF: renamed from: a (com.google.android.gms.drive.realtime.internal.EndCompoundOperationRequest, android.os.Parcel, int) void
    static void method_4252(EndCompoundOperationRequest var0, Parcel var1, int var2) {
        int var3 = class_823.method_4298(var1);
        class_823.method_4325(var1, 1, var0.field_5202);
        class_823.method_4301(var1, var3);
    }

    // $FF: renamed from: aV (android.os.Parcel) com.google.android.gms.drive.realtime.internal.EndCompoundOperationRequest
    public EndCompoundOperationRequest method_4253(Parcel var1) {
    ...
    // $FF: renamed from: ch (int) com.google.android.gms.drive.realtime.internal.EndCompoundOperationRequest[]
    public EndCompoundOperationRequest[] method_4254(int var1) {
        return new EndCompoundOperationRequest[var1];
    }

    // $FF: synthetic method
    public Object createFromParcel(Parcel var1) {
        return this.method_4253(var1);
    }

    // $FF: synthetic method
    public Object[] newArray(int var1) {
        return this.method_4254(var1);
    }
}
