...
public interface class_129 extends IInterface {
    ...
    void method_655(ParcelableCollaborator[] var1) throws RemoteException;

    // $FF: renamed from: o (com.google.android.gms.common.api.Status) void
    void method_656(Status var1) throws RemoteException;

    public abstract static class class_1408 extends Binder implements class_129 {
        // $FF: renamed from: aa (android.os.IBinder) com.google.android.gms.drive.realtime.internal.e
        public static class_129 method_3893(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.drive.realtime.internal.ICollaboratorsCallback");
                return (class_129)(var1 != null && var1 instanceof class_129?(class_129)var1:new class_129.class_1409(var0));
            }
        }
    ...
    private static class class_1409 implements class_129 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_3149;

        class_1409(IBinder var1) {
            this.field_3149 = var1;
        }

        // $FF: renamed from: a (com.google.android.gms.drive.realtime.internal.ParcelableCollaborator[]) void
        public void method_655(ParcelableCollaborator[] var1) throws RemoteException {
            ...
            try {
                ...
                this.field_3149.transact(1, var2, var3, 0);
                var3.readException();
            } finally {
                var3.recycle();
                var2.recycle();
        ...
        // $FF: renamed from: o (com.google.android.gms.common.api.Status) void
        public void method_656(Status param1) throws RemoteException {
