...
public interface class_4 extends IInterface {
    ...
    public abstract static class class_1321 extends Binder implements class_4 {
        public class_1321() {
        ...
        public static class_4 method_1590(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.ads.internal.client.IAppEventListener");
                return (class_4)(var1 != null && var1 instanceof class_4?(class_4)var1:new class_4.class_1322(var0));
            }
        }
    ...
    private static class class_1322 implements class_4 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_4517;

        class_1322(IBinder var1) {
            this.field_4517 = var1;
        }

        public IBinder asBinder() {
            return this.field_4517;
        }
        ...
        public void onAppEvent(String var1, String var2) throws RemoteException {
            ...
            try {
                ...
                this.field_4517.transact(1, var3, var4, 0);
                var4.readException();
            } finally {
                var4.recycle();
                var3.recycle();
