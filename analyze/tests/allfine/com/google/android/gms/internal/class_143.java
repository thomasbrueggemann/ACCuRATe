...
public interface class_143 extends IInterface {
    ...
    public abstract static class class_1197 extends Binder implements class_143 {
        public class_1197() {
            this.attachInterface(this, "com.google.android.gms.location.internal.IGeofencerCallbacks");
        }

        // $FF: renamed from: aJ (android.os.IBinder) com.google.android.gms.internal.lw
        public static class_143 method_2352(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
                return (class_143)(var1 != null && var1 instanceof class_143?(class_143)var1:new class_143.class_1198(var0));
            }
        }
    ...
    private static class class_1198 implements class_143 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_5121;

        class_1198(IBinder var1) {
            this.field_5121 = var1;
        }

        public IBinder asBinder() {
            return this.field_5121;
        }
        ...
        public void onAddGeofencesResult(int var1, String[] var2) throws RemoteException {
            ...
            try {
                ...
                this.field_5121.transact(1, var3, var4, 0);
                var4.readException();
            } finally {
                var4.recycle();
                var3.recycle();
        ...
        public void onRemoveGeofencesByRequestIdsResult(int var1, String[] var2) throws RemoteException {
            ...
            try {
                ...
                var3.writeInt(var1);
                var3.writeStringArray(var2);
                this.field_5121.transact(2, var3, var4, 0);
                var4.readException();
            } finally {
                var4.recycle();
                var3.recycle();
