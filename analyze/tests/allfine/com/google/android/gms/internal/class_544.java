...
public class class_544 {
    // $FF: renamed from: kW java.security.SecureRandom
    private final SecureRandom field_2895;
    // $FF: renamed from: ky com.google.android.gms.internal.m
    private final class_66 field_2896;

    public class_544(class_66 var1, SecureRandom var2) {
        this.field_2896 = var1;
        this.field_2895 = var2;
    }

    // $FF: renamed from: c (byte[]) void
    static void method_3323(byte[] var0) {
    ...
    public byte[] method_3324(String var1) throws class_544.class_1662 {
        try {
            byte[] var3 = this.field_2896.method_320(var1, false);
            if(var3.length != 32) {
                throw new class_544.class_1662();
            } else {
            ...
            throw new class_544.class_1662(var6);
        }
    }

    // $FF: renamed from: c (byte[], java.lang.String) byte[]
    public byte[] method_3325(byte[] var1, String var2) throws class_544.class_1662 {
        if(var1.length != 16) {
            throw new class_544.class_1662();
        } else {
            try {
                byte[] var10 = this.field_2896.method_320(var2, false);
                if(var10.length <= 16) {
                    throw new class_544.class_1662();
                } else {
                ...
                throw new class_544.class_1662(var21);
            } catch (InvalidKeyException var22) {
                throw new class_544.class_1662(var22);
            } catch (IllegalBlockSizeException var23) {
                throw new class_544.class_1662(var23);
            } catch (NoSuchPaddingException var24) {
                throw new class_544.class_1662(var24);
            } catch (BadPaddingException var25) {
                throw new class_544.class_1662(var25);
            } catch (InvalidAlgorithmParameterException var26) {
                throw new class_544.class_1662(var26);
            } catch (IllegalArgumentException var27) {
                throw new class_544.class_1662(var27);
            }
        }
    }

    public class class_1662 extends Exception {
        public class_1662() {
        }

        public class_1662(Throwable var2) {
            super(var2);
        }
    }
}
