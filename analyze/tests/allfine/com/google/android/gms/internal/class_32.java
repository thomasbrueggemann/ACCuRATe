...
public interface class_32 extends IInterface {
    ...
    public abstract static class class_1468 extends Binder implements class_32 {
        public class_1468() {
            this.attachInterface(this, "com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
        }

        // $FF: renamed from: w (android.os.IBinder) com.google.android.gms.internal.ek
        public static class_32 method_2683(IBinder var0) {
            if(var0 == null) {
                return null;
            } else {
                IInterface var1 = var0.queryLocalInterface("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                return (class_32)(var1 != null && var1 instanceof class_32?(class_32)var1:new class_32.class_1469(var0));
            }
        }
    ...
    private static class class_1469 implements class_32 {
        // $FF: renamed from: lb android.os.IBinder
        private IBinder field_3460;

        class_1469(IBinder var1) {
        ...
        public void finishPurchase() throws RemoteException {
            ...
            try {
                ...
                this.field_3460.transact(5, var1, var2, 0);
                var2.readException();
            } finally {
                var2.recycle();
                var1.recycle();
        ...
        public String getProductId() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                this.field_3460.transact(1, var1, var2, 0);
                var2.readException();
        ...
        public Intent getPurchaseData() throws RemoteException {
            ...
            label36: {
                try {
                    var7 = true;
                    var1.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                    this.field_3460.transact(2, var1, var2, 0);
                    var2.readException();
                    if(var2.readInt() != 0) {
        ...
        public int getResultCode() throws RemoteException {
            ...
            try {
                var1.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                this.field_3460.transact(3, var1, var2, 0);
                var2.readException();
                var5 = var2.readInt();
            } finally {
                var2.recycle();
        ...
        public boolean isVerified() throws RemoteException {
            ...
            try {
                var8 = true;
                var1.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                this.field_3460.transact(4, var1, var2, 0);
                var2.readException();
                var5 = var2.readInt();
                var8 = false;
            } finally {
