...
public class class_656 extends j<AppVisibleCustomProperties> {
    public class_656(int var1) {
    ...
    protected Object method_3645(DataHolder var1, int var2, int var3) {
        return this.method_3672(var1, var2, var3);
    }
    ...
    protected AppVisibleCustomProperties method_3672(DataHolder var1, int var2, int var3) {
        return (AppVisibleCustomProperties)var1.method_5998().getSparseParcelableArray("customPropertiesExtra").get(var2, AppVisibleCustomProperties.field_2949);
    }
}
