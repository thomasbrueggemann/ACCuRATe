...
public class class_840 implements BleApi {
    // $FF: renamed from: Ue com.google.android.gms.common.api.Status
    private static final Status field_4123 = new Status(5007);

    public PendingResult<Status> claimBleDevice(GoogleApiClient var1, BleDevice var2) {
        return new class_849(field_4123);
    }
    ...
    public PendingResult<BleDevicesResult> listClaimedBleDevices(GoogleApiClient var1) {
        return new class_849(BleDevicesResult.method_3494(field_4123));
    }
