...
public final class SearchAdView extends ViewGroup {
    ...
    private final class_238 field_4778;

    public SearchAdView(Context var1) {
        super(var1);
        this.field_4778 = new class_238(this);
    }

    public SearchAdView(Context var1, AttributeSet var2) {
        super(var1, var2);
        this.field_4778 = new class_238(this, var2, false);
    }
    ...
    public void destroy() {
        this.field_4778.destroy();
    }

    public AdListener getAdListener() {
        return this.field_4778.getAdListener();
    }

    public AdSize getAdSize() {
        return this.field_4778.getAdSize();
    }

    public String getAdUnitId() {
        return this.field_4778.getAdUnitId();
    }

    public void loadAd(SearchAdRequest var1) {
        this.field_4778.method_1585(var1.method_3008());
    }
    ...
    public void pause() {
        this.field_4778.pause();
    }

    public void resume() {
        this.field_4778.resume();
    }

    public void setAdListener(AdListener var1) {
        this.field_4778.setAdListener(var1);
    }

    public void setAdSize(AdSize var1) {
        this.field_4778.setAdSizes(new AdSize[] {var1});
    }

    public void setAdUnitId(String var1) {
        this.field_4778.setAdUnitId(var1);
    }
}
