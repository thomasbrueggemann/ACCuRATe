...
public final class PublisherAdView extends ViewGroup {
    ...
    private final class_238 field_4603;

    public PublisherAdView(Context var1) {
        super(var1);
        this.field_4603 = new class_238(this);
    }

    public PublisherAdView(Context var1, AttributeSet var2) {
        super(var1, var2);
        this.field_4603 = new class_238(this, var2, true);
    }
    ...
    public void destroy() {
        this.field_4603.destroy();
    }

    public AdListener getAdListener() {
        return this.field_4603.getAdListener();
    }

    public AdSize getAdSize() {
        return this.field_4603.getAdSize();
    }

    public AdSize[] getAdSizes() {
        return this.field_4603.getAdSizes();
    }

    public String getAdUnitId() {
        return this.field_4603.getAdUnitId();
    }

    public AppEventListener getAppEventListener() {
        return this.field_4603.getAppEventListener();
    }

    public String getMediationAdapterClassName() {
        return this.field_4603.getMediationAdapterClassName();
    }

    public void loadAd(PublisherAdRequest var1) {
        this.field_4603.method_1585(var1.method_5357());
    }
    ...
    public void pause() {
        this.field_4603.pause();
    }

    public void recordManualImpression() {
        this.field_4603.recordManualImpression();
    }

    public void resume() {
        this.field_4603.resume();
    }

    public void setAdListener(AdListener var1) {
        this.field_4603.setAdListener(var1);
    }

    public void setAdSizes(AdSize... var1) {
        if(var1 != null && var1.length >= 1) {
            this.field_4603.method_1586(var1);
        } else {
    ...
    public void setAdUnitId(String var1) {
        this.field_4603.setAdUnitId(var1);
    }

    public void setAppEventListener(AppEventListener var1) {
        this.field_4603.setAppEventListener(var1);
    }
}
