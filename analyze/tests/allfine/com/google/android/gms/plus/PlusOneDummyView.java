...
public class PlusOneDummyView extends FrameLayout {
    ...
    public PlusOneDummyView(Context var1, int var2) {
        ...
        var3.setBackgroundDrawable(this.method_5970().getDrawable(var2));
        Point var4 = this.method_5969(var2);
        this.addView(var3, new LayoutParams(var4.x, var4.y, 17));
    }

    // $FF: renamed from: eQ (int) android.graphics.Point
    private Point method_5969(int var1) {
        byte var2 = 24;
        byte var3 = 20;
    ...
    // $FF: renamed from: na () com.google.android.gms.plus.PlusOneDummyView$d
    private PlusOneDummyView.class_1761 method_5970() {
        Object var1 = new PlusOneDummyView.class_1763(this.getContext());
        if(!((PlusOneDummyView.class_1761)var1).isValid()) {
            var1 = new PlusOneDummyView.class_1764(this.getContext());
        }

        if(!((PlusOneDummyView.class_1761)var1).isValid()) {
            var1 = new PlusOneDummyView.class_1762(this.getContext());
        }

        return (PlusOneDummyView.class_1761)var1;
    }

    private static class class_1762 implements PlusOneDummyView.class_1761 {
        private Context mContext;

        private class_1762(Context var1) {
            this.mContext = var1;
        }

        // $FF: synthetic method
        class_1762(Context var1, Object var2) {
            this(var1);
        }
    ...
    private static class class_1763 implements PlusOneDummyView.class_1761 {
        private Context mContext;

        private class_1763(Context var1) {
            this.mContext = var1;
        }

        // $FF: synthetic method
        class_1763(Context var1, Object var2) {
            this(var1);
        }
    ...
    private static class class_1764 implements PlusOneDummyView.class_1761 {
        private Context mContext;

        private class_1764(Context var1) {
            this.mContext = var1;
        }

        // $FF: synthetic method
        class_1764(Context var1, Object var2) {
            this(var1);
        }
