...
public final class PlusShare {
    ...
    public static Bundle method_5426(String var0, String var1, Uri var2) {
    ...
    // $FF: renamed from: cd (java.lang.String) boolean
    protected static boolean method_5427(String var0) {
    ...
    public static Person createPerson(String var0, String var1) {
        if(TextUtils.isEmpty(var0)) {
            ...
            return new class_272(var1, var0, (class_272.class_1291)null, 0, (String)null);
        }
    }
    ...
    public static class Builder {
        ...
        public Builder(Activity var1, PlusClient var2) {
            ...
            class_1090.method_5676(var3, "PlusClient must not be null.");
            class_1090.method_5676(var2.isConnected(), "PlusClient must be connected to create an interactive post.");
            class_1090.method_5676(var2.method_3261().method_1848("https://www.googleapis.com/auth/plus.login"), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public PlusShare.Builder addCallToAction(String var1, Uri var2, String var3) {
            class_1090.method_5676(this.alr, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean var4;
            ...
            class_1090.method_5683(var4, "Must provide a call to action URL");
            ...
            if(!TextUtils.isEmpty(var3)) {
                class_1090.method_5676(PlusShare.method_5427(var3), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            byte var1 = 1;
            byte var2;
            if(this.als != null && this.als.size() > var1) {
                var2 = var1;
            } else {
                var2 = 0;
            }
            ...
            class_1090.method_5676((boolean)var5, "Call-to-action buttons are only available for URLs.");
            byte var6;
            ...
            class_1090.method_5676((boolean)var6, "The content URL is required for interactive posts.");
            ...
            class_1090.method_5676((boolean)var1, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if(this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")) {
                class_1090.method_5676(PlusShare.method_5427(this.mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
            }
        ...
        public PlusShare.Builder setContentDeepLinkId(String var1, String var2, String var3, Uri var4) {
            class_1090.method_5683(this.alr, "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            boolean var5;
            if(!TextUtils.isEmpty(var1)) {
                var5 = true;
            } else {
            ...
            class_1090.method_5683(var5, "The deepLinkId parameter is required.");
            Bundle var6 = PlusShare.method_5426(var2, var3, var4);
