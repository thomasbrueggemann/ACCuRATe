...
public class HitBuilders {
    ...
    public static class AppViewBuilder extends HitBuilders.HitBuilder<HitBuilders.AppViewBuilder> {
        public AppViewBuilder() {
            class_940.method_4863().method_4865(class_940.class_1617.field_4913);
    ...
    public static class EventBuilder extends HitBuilders.HitBuilder<HitBuilders.EventBuilder> {
        public EventBuilder() {
            class_940.method_4863().method_4865(class_940.class_1617.field_4901);
            this.set("&t", "event");
        }
    ...
    public static class ExceptionBuilder extends HitBuilders.HitBuilder<HitBuilders.ExceptionBuilder> {
        public ExceptionBuilder() {
            class_940.method_4863().method_4865(class_940.class_1617.field_4927);
        ...
        public HitBuilders.ExceptionBuilder setFatal(boolean var1) {
            this.set("&exf", class_953.method_5019(var1));
            return this;
        }
    }

    protected static class HitBuilder<T extends HitBuilders.HitBuilder> {
        // $FF: renamed from: AI java.util.Map
        private Map<String, String> field_2084 = new HashMap();
        // $FF: renamed from: AJ com.google.android.gms.analytics.ecommerce.ProductAction
        ProductAction field_2085;
        // $FF: renamed from: AK java.util.Map
        Map<String, List<Product>> field_2086 = new HashMap();
        // $FF: renamed from: AL java.util.List
        List<Promotion> field_2087 = new ArrayList();
        // $FF: renamed from: AM java.util.List
        List<Product> field_2088 = new ArrayList();

        public T addImpression(Product var1, String var2) {
            if(var1 == null) {
                class_938.method_4861("product should be non-null");
                return this;
            } else {
                if(var2 == null) {
                    var2 = "";
                ...
                if(!this.field_2086.containsKey(var2)) {
                    this.field_2086.put(var2, new ArrayList());
                }

                ((List)this.field_2086.get(var2)).add(var1);
                return this;
            }
        }
        ...
        public T addPromotion(Promotion var1) {
            if(var1 == null) {
                class_938.method_4861("promotion should be non-null");
                return this;
            } else {
                this.field_2087.add(var1);
                return this;
            }
        }

        public Map<String, String> build() {
            HashMap var1 = new HashMap(this.field_2084);
            if(this.field_2085 != null) {
                var1.putAll(this.field_2085.build());
            }

            Iterator var2 = this.field_2087.iterator();

            for(int var3 = 1; var2.hasNext(); ++var3) {
                var1.putAll(((Promotion)var2.next()).method_3787(class_928.method_4791(var3)));
            }

            Iterator var4 = this.field_2088.iterator();

            for(int var5 = 1; var4.hasNext(); ++var5) {
                var1.putAll(((Product)var4.next()).method_6015(class_928.method_4799(var5)));
            }

            Iterator var6 = this.field_2086.entrySet().iterator();

            for(int var7 = 1; var6.hasNext(); ++var7) {
                Entry var8 = (Entry)var6.next();
                List var9 = (List)var8.getValue();
                String var10 = class_928.method_4793(var7);
                Iterator var11 = var9.iterator();

                for(int var12 = 1; var11.hasNext(); ++var12) {
                    var1.putAll(((Product)var11.next()).method_6015(var10 + class_928.method_4792(var12)));
                }
        ...
        protected String get(String var1) {
            return (String)this.field_2084.get(var1);
        }

        public final T set(String var1, String var2) {
            class_940.method_4863().method_4865(class_940.class_1617.field_4941);
            if(var1 != null) {
                this.field_2084.put(var1, var2);
                return this;
            } else {
                class_938.method_4861(" HitBuilder.set() called with a null paramName.");
                return this;
            }
        }

        public final T setAll(Map<String, String> var1) {
            class_940.method_4863().method_4865(class_940.class_1617.field_4942);
            if(var1 == null) {
                return this;
            } else {
                this.field_2084.putAll(new HashMap(var1));
                return this;
            }
        }

        public T setCampaignParamsFromUrl(String var1) {
            class_940.method_4863().method_4865(class_940.class_1617.field_4944);
            String var2 = class_953.method_5025(var1);
            if(TextUtils.isEmpty(var2)) {
                return this;
            } else {
                Map var3 = class_953.method_5024(var2);
        ...
        public T setCustomDimension(int var1, String var2) {
            this.set(class_928.method_4797(var1), var2);
            return this;
        }

        public T setCustomMetric(int var1, float var2) {
            this.set(class_928.method_4798(var1), Float.toString(var2));
            return this;
        }
        ...
        public T setNonInteraction(boolean var1) {
            this.set("&ni", class_953.method_5019(var1));
            return this;
        }
        ...
        public T setPromotionAction(String var1) {
            this.field_2084.put("&promoa", var1);
            return this;
        }
    }
    ...
    public static class ItemBuilder extends HitBuilders.HitBuilder<HitBuilders.ItemBuilder> {
        public ItemBuilder() {
            class_940.method_4863().method_4865(class_940.class_1617.field_4902);
            this.set("&t", "item");
        }
    ...
    public static class SocialBuilder extends HitBuilders.HitBuilder<HitBuilders.SocialBuilder> {
        public SocialBuilder() {
            class_940.method_4863().method_4865(class_940.class_1617.field_4930);
            this.set("&t", "social");
        }
    ...
    public static class TimingBuilder extends HitBuilders.HitBuilder<HitBuilders.TimingBuilder> {
        public TimingBuilder() {
            class_940.method_4863().method_4865(class_940.class_1617.field_4929);
            this.set("&t", "timing");
        }
    ...
    public static class TransactionBuilder extends HitBuilders.HitBuilder<HitBuilders.TransactionBuilder> {
        public TransactionBuilder() {
            class_940.method_4863().method_4865(class_940.class_1617.field_4926);
